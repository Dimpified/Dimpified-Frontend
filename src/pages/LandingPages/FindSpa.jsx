...
const FindSpa = ({ subdomain }) => {
  ...
  // Fetch countries and random spa centre on mount
  useEffect(() => {
  ...
  // Fetch random spa centre
  const fetchRandomSpas = async () => {
    setIsLoading(true);
    try {
      const data = await api.getEcosystemsNearMe({
        ...
        SubCategory: "Spa and Wellness Center",
        format: "Onsite",
      });
      const randomSpas = data.ecosystems?.sort(() => 0.5 - Math.random()) || [];
      setEcosystems(randomSpas);
    } catch (err) {
      setError(err.message || "Failed to fetch spa centre.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    try {
      ...
      if (data?.ecosystems?.length) {
        ...
        if (filteredEcosystems.length > 0) {
          ...
          setNotification(
            " No spa centre found near you, kindly search nearer local government or state."
          );
          setEcosystems([]);
        }
      } else {
  ...
  return (
    ...
    >
       <Helmet>
              <title>Find a spa near you </title>
              <meta
                name="description"
                content="Find a spa near you with Dimpified "
              />
              <meta property="og:title" content=" Find a spa near you " />
              <meta
      ...
      <div className="font-sen">
        ...
        <section
          ...
          style={{
            backgroundImage: `url("https://gfa-tech.com/dimp-template-images/spa/galleryspa2.jpg")`,
          }}
        >
                ...
                {currentEcosystems
                  ...
                  .map((ecosystem, index) => {
                    ...
                    const serviceImage =
                      ...
                      "https://gfa-tech.com/dimp-template-images/spa/galleryspa2.jpg";
