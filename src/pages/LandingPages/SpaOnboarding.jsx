...
import Csr from "./images/editwebsite.jpg";
              ...
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                <div className="bg-primary3 rounded-full py-2 px-5 mb-5 w-max mx-auto md:mx-0">
                  <span className="font-semibold text-xs uppercase text-dark">
                    Plans start at just ₦4,500/month.
                  </span>
                </div>
                ...
                >
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      ...
                      Since joining Dimpified, I no longer miss bookings. I just
                      wake up and see money
                      <FaQuoteRight className="inline pl-2 text-2xl text-primary3 align-bottom" />
                      <br />— <strong>Peace, Glow Up Spa, Port Harcourt</strong>
                    </p>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      <FaQuoteLeft className="inline pr-2 text-2xl text-primary3 align-top" />
                      My clients say it’s easier to book now. I say it’s easier
                      to get paid.
                      <FaQuoteRight className="inline pl-2 text-2xl text-primary3 align-bottom" />
                      <br />— <strong>Mimi, Revive Skincare Spa, Abuja</strong>
                    </p>
                  </SwiperSlide>
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      <FaQuoteLeft className="inline pr-2 text-2xl text-primary3 align-top" />
                      I made over ₦600,000 in 2 months after setting up my
                      Dimpified link.
                      <FaQuoteRight className="inline pl-2 text-2xl text-primary3 align-bottom" />
                      <br />— <strong> Amanda, Luxé Touch Spa, Lagos</strong>
                    </p>
                  </SwiperSlide>
                </Swiper>
              </div>
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-semibold text-lg">
                            Can I accept Nigerian payments?
                          </h3>
                          <span className="flex items-center">
                            {open ? "-" : "+"}
                          </span>
