...
const ThirdDentist = ({ userDetails, subdomain }) => {
  ...
  return (
    <div>
        ...
        <div className="lg:flex gap-4">
          ...
          <div className="mt-7 flex-1">
            ...
            <EditTemplateLongInput
              ...
              onChange={(event) => handleContentChange("hero", "span2", event)}
              placeholder="Enter your domain..."
              className="custom-input-class"
            />
          </div>
      ...
      <div className="lg:flex gap-5 py-5">
        ...
        />
        <EditTemplateLongInput
          value={sanitizeContent(details && details.aboutUs.image2)}
          onChange={(event) => handleContentChange("aboutUs", "image2", event)}
          placeholder="Enter your domain..."
          className="custom-input-class"
        />
      </div>
      ...
      <div className="lg:flex gap-5 py-5">
        ...
        <EditTemplateLongInput
          ...
          onChange={(event) => handleContentChange("aboutUs", "image3", event)}
          placeholder="Enter your domain..."
          className="custom-input-class"
        />
        <EditTemplateLongInput
          value={sanitizeContent(details && details.aboutUs.image4)}
          onChange={(event) => handleContentChange("aboutUs", "image4", event)}
          placeholder="Enter your domain..."
          className="custom-input-class"
        />
      </div>
      <div className="lg:flex gap-5 py-5">
        <EditTemplateLongInput
          value={sanitizeContent(details && details.Patrners.sectionImage1)}
          onChange={(event) =>
        ...
        />
        <EditTemplateLongInput
          value={sanitizeContent(details && details.Patrners.sectionImage2)}
          onChange={(event) =>
      ...
      <div className="lg:flex gap-5 py-5">
        <EditTemplateLongInput
          value={sanitizeContent(details && details.Patrners.sectionImage3)}
          onChange={(event) =>
              ...
              >
                <div className="relative">
                  ...
                  {userPlan && userPermissions.canEditImage && (
                    <div className="absolute top-2 left-2">
                      <ButtonSmallPurple
                        width="110"
                        onClick={() =>
                          fileInputRefs.current[`Gallery-image${idx}`]?.click()
                        }
                      >
                        {loadingImage ? <LoadingSmall /> : "Edit Image"}
                      </ButtonSmallPurple>
                  ...
                  <input
                    type="file"
                    ref={(ref) =>
                      (fileInputRefs.current[`Gallery-image${idx}`] = ref)
                    }
                    onChange={(e) =>
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                ...
                >
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-4">
                      <h3 className="text-lg lg:text-xl font-semibold text-[#031B4E]">
                        ...
                        <EditTemplateLongInput
                          value={sanitizeContent(
                            details?.Statistics?.[`section${index + 2}header`]
                          )}
                          onChange={(event) =>
                            handleContentChange(
                              "Statistics",
                              `section${index + 2}header`,
                              event
                            )
                          }
                          placeholder="Enter your domain..."
                  ...
                  <EditTemplateLongInput
                    value={sanitizeContent(
                      details?.Statistics?.[`section${index + 2}paragraphy`]
                    )}
                    onChange={(event) =>
                      handleContentChange(
                        "Statistics",
                        `section${index + 2}paragraphy`,
                        event
                      )
                    }
                    placeholder="Enter your domain..."
        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10">
            {doctors.map((doctor, idx) => (
              ...
              >
                <div className="rounded-full w-40 h-50 mx-auto mt-6 overflow-hidden relative">
                  <img
                    src={doctor.image}
                    alt={doctor.name}
                  ...
                  {userPlan && userPermissions.canEditImage && (
                    <div className="absolute top-2 left-2">
                      <ButtonSmallPurple
                        width="110"
                        onClick={() =>
                          fileInputRefs.current[`Team-image${idx + 1}`]?.click()
                        }
                      >
                        {loadingImage ? <LoadingSmall /> : "Edit Image"}
                      </ButtonSmallPurple>
                ...
                <div className="p-4 transition-all duration-300 group-hover:text-white">
                  ...
                  <EditTemplateLongInput
                    value={sanitizeContent(
                      details?.Team?.[`summary${idx + 1}`]
                    )}
                    onChange={(event) =>
                      handleContentChange("Team", `summary${idx + 1}`, event)
                    }
                    placeholder="Enter your domain..."
                  ...
                  <EditTemplateLongInput
                    value={sanitizeContent(details?.Team?.[`header${idx + 1}`])}
                    onChange={(event) =>
                      handleContentChange("Team", `header${idx + 1}`, event)
                    }
                    placeholder="Enter your domain..."
                    className="custom-input-class my-6 text-black"
                  />
      ...
      <section className="bg-white py-16 px-4 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div>
            ...
            <EditTemplateLongInput
              value={sanitizeContent(details && details.Reviews.image3)}
              onChange={(event) =>
                handleContentChange("Reviews", "image3", event)
              }
              placeholder="Enter your domain..."
              className="custom-input-class"
            />
            ...
            <div className="grid grid-cols-1  gap-6">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="bg-[#f5f9ff] border border-[#dbeafe] rounded-xl p-6 shadow-sm flex flex-col justify-between"
                >
                  {/* Card Number */}
                  <div className="flex items-center justify-start mb-4">
                    <div className="bg-[#006D77] text-white text-sm font-semibold px-3 py-2 rounded-full shadow">
                      {index + 1}
                    </div>
                  </div>

                  {/* Testimonial Text */}
                  <p className="text-[#0a1f44] text-lg leading-relaxed mb-4">
                    {testimonial.text}
                  </p>
                  <EditTemplateLongInput
                    value={sanitizeContent(
                  ...
                  <div className="flex justify-between items-end mt-auto pt-4">
                    <div>
                      <p className="text-xl text-[#031B4E] font-bold">
                        {testimonial.name}
                      </p>
                      <EditTemplateLongInput
                        value={sanitizeContent(
      ...
      <footer className="bg-[#f3f7fd] text-blue-900 pt-16 px-6 md:px-12 relative">
        ...
        <div className="flex h-full py-4 px-4 lg:px-24 mt-16  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
          ...
          {/* Clinic Hours */}
          <div className="flex-1">
            <h4 className="font-semibold mb-4 text-[#031B4E]"> {sanitizeContent(details && details.Patrners.sectionImage1)}</h4>
            <ul className="space-y-2 text-[#4A5B80]">
              <li>
                <strong>{sanitizeContent(details && details.Patrners.section1header)}:</strong> {sanitizeContent(details && details.Patrners.sectionImage2)}
              </li>
              <li>
                <strong>{sanitizeContent(details && details.Patrners.section2header)}:</strong> {sanitizeContent(details && details.Patrners.sectionImage3)}
              </li>
              <li>
                <strong>{sanitizeContent(details && details.Patrners.section3header)}:</strong> {sanitizeContent(details && details.Patrners.sectionImage4)}
              </li>
            </ul>
          </div>
