  ...
  (
    {
      ...
      lineHeight = "leading-7",
      onChange,
      required = false, // Changed to boolean
    ...
    return (
      <input
        ref={ref}
        className={`w-full h-12 font-body rounded border text-${size} placeholder-${color} ${weight} ${lineHeight} ${className} p-2 outline-none`}
        placeholder={placeholder}
        onKeyDown={onKeyDown} // Uses the passed prop
        onChange={onChange}
        {...rest}
        required={required}
      />
