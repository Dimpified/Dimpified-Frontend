...
const BookingModal = ({ isOpen, handleClose, information, subdomain }) => {
  ...
  const handlePay = () => {
    ...
    sessionStorage.setItem("productPrice", priceToSend);
    setTotalAmount(priceToSend);
          ...
          <div className="py-4 overflow-y-auto">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="w-full md:w-8/12">
                  ...
                  <p className="text-gray-500 mb-4 text-sm">
                    Kindly click on the preferred time till it selects with
                    purple
                  </p>
                  <p className="text-purple-500 mb-4">
                    {selectedTimeSlot
                      ? selectedTimeSlot
                      : "Preferred time has not been selected"}
                  </p>
            ...
            {!loading && step === 2 && (
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                  <label className="block text-sm">
                    Additional details for the service provider (optional)
                  </label>
                  <textarea
                    name="details"
