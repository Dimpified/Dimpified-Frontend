...
const SeventhStylist = ({ userDetails, subdomain }) => {
  ...
  useEffect(() => {
    const counters = [
      {
        id: "odometer1",
        target: parseInt(details?.Statistics?.section4header) || 18,
      },
      {
        id: "odometer2",
        target: parseInt(details?.Statistics?.section3header) || 152,
      },
      {
        id: "odometer3",
        target: parseInt(details?.Statistics?.section4span) || 52,
      },
  ...
  const testimonialsData = [
    {
      ...
      name: details?.Reviews?.header2 || "KENDE ATTILA",
      position: details?.Reviews?.title2 || "Software Tester",
      image:
    ...
    },
    {
      ...
      name: details?.Reviews?.header3 || "SARAH JOHNSON",
      position: details?.Reviews?.title3 || "Marketing Executive",
      image:
    ...
    },
    {
      text:
        ...
        "Demure completely transformed my look – brilliant colour work!",
      name: details?.Reviews?.header4 || "MONICA WELLS",
      position: details?.Reviews?.title4 || "Bank Manager",
      image:
  ...
  return (
    <div className={`font-sans text-gray-800`}>
      {/* Header */}
      <header className={`w-full z-30 shadow-sm`}>
      ...
      <section
        id="home"
        className={`relative min-h-screen flex flex-col lg:flex-row items-center pt-20 sm:pt-32 bg-black
        ...
        <div className="mt-7">
          ...
          <div className="lg:flex gap-4">
            <div className="flex-1">
              ...
              <EditTemplateLongInput
                value={sanitizeContent(details?.hero?.summary1)}
                onChange={(e) => handleContentChange("hero", "summary1", e)}
            ...
            <div className="flex-1">
              ...
              <EditTemplateLongInput
                value={sanitizeContent(details?.hero?.buttonText1)}
                onChange={(e) => handleContentChange("hero", "buttonText1", e)}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 text-center gap-6">
            <div>
              <p id="odometer1" className="text-3xl font-bold text-[#1e1e1e]">
                {sanitizeContent(details?.Statistics?.section4header || "18+")}
              </p>
              <p className="text-[#1e1e1e] text-sm mt-2">
                {sanitizeContent(
                  details?.Statistics?.section4paragraphy ||
              ...
              <EditTemplateLongInput
                ...
                onChange={(e) =>
                  handleContentChange("Statistics", "section4header", e)
                }
                placeholder="Edit counter..."
                className="custom-input-class text-black"
              />
              <EditTemplateLongInput
                value={sanitizeContent(details?.Statistics?.section4paragraphy)}
                onChange={(e) =>
                  handleContentChange("Statistics", "section4paragraphy", e)
                }
            ...
            <div>
              <p id="odometer2" className="text-3xl font-bold text-[#1e1e1e]">
                {sanitizeContent(details?.Statistics?.section3header || "152+")}
              </p>
              <p className="text-[#1e1e1e] text-sm mt-2">
                {sanitizeContent(
                  details?.Statistics?.section3paragraphy || "Happy Clients"
                )}
              </p>
              <EditTemplateLongInput
                value={sanitizeContent(details?.Statistics?.section3header)}
                onChange={(e) =>
                  handleContentChange("Statistics", "section3header", e)
                }
                placeholder="Edit counter..."
                className="custom-input-class text-black"
              />
              <EditTemplateLongInput
                value={sanitizeContent(details?.Statistics?.section3paragraphy)}
                onChange={(e) =>
                  handleContentChange("Statistics", "section3paragraphy", e)
                }
                placeholder="Edit text..."
                className="custom-input-class text-black"
              />
            ...
            <div>
              <p id="odometer3" className="text-3xl font-bold text-[#1e1e1e]">
                {sanitizeContent(details?.Statistics?.section4span || "52+")}
              </p>
              <p className="text-[#1e1e1e] text-sm mt-2">
                {sanitizeContent(
                  details?.Statistics?.section4icon || "Expert Analysts"
                )}
              </p>
              <EditTemplateLongInput
                value={sanitizeContent(details?.Statistics?.section4span)}
                onChange={(e) =>
                  handleContentChange("Statistics", "section4span", e)
                }
                placeholder="Edit counter..."
                className="custom-input-class text-black"
              />
              <EditTemplateLongInput
                value={sanitizeContent(details?.Statistics?.section4icon)}
                onChange={(e) =>
                  handleContentChange("Statistics", "section4icon", e)
                }
                placeholder="Edit text..."
                className="custom-input-class text-black"
              />
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/2 relative z-10">
              <span className="sub-heading block text-[#D2B095] mb-2">
                {sanitizeContent(details?.aboutUs?.title1 || "About Demure")}
                <EditTemplateLongInput
                  value={sanitizeContent(details?.aboutUs?.title1)}
                  onChange={(e) => handleContentChange("aboutUs", "title1", e)}
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
              </span>
              <h2 className="text-3xl font-bold mb-4 uppercase">
                ...
                <EditTemplateLongInput
                  ...
                  onChange={(e) => handleContentChange("aboutUs", "title2", e)}
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
              </h2>
              <p className="mb-6 max-w-lg">
                ...
                <EditTemplateLongInput
                  ...
                  onChange={(e) => handleContentChange("aboutUs", "text1", e)}
                  placeholder="Edit text..."
                  className="custom-input-class text-black"
                />
              </p>
      ...
      <section
        className={`services py-20 ${
          details?.aboutUs?.styles?.backgroundColor || "bg-[#F7F3F0]"
        }`}
        id="services"
      >
        <div className="container mx-auto px-4">
            ...
            <div className="lg:w-1/2">
              <span className="block text-[#D2B095] mb-2 italic">
                ...
                <EditTemplateLongInput
                  ...
                  onChange={(e) =>
                    handleContentChange("Statistics", "section1header", e)
                  }
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
              ...
              <h2 className="text-3xl font-bold uppercase text-gray-900">
                ...
                <EditTemplateLongInput
                  ...
                  onChange={(e) =>
                    handleContentChange("Statistics", "section1paragraphy", e)
                  }
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
            ...
            <div className="lg:w-1/2 text-gray-700 text-base">
              <p className="mb-4">
                ...
                <EditTemplateLongInput
                  ...
                  onChange={(e) =>
                    handleContentChange("Statistics", "section1span", e)
                  }
                  placeholder="Edit text..."
                  className="custom-input-class text-black"
                />
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="bg-[#F7F3F0] p-8 lg:p-12 lg:w-9/12 rounded shadow-sm">
              <span className="italic text-[#B99374] block mb-2">
                {sanitizeContent(
                  details?.Statistics?.section2header ||
                    "Exceptional Client Care"
                )}
                <EditTemplateLongInput
                  value={sanitizeContent(details?.Statistics?.section2header)}
                  onChange={(e) =>
                    handleContentChange("Statistics", "section2header", e)
                  }
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 uppercase">
                {sanitizeContent(
                  details?.Statistics?.section2paragraphy || "Premium Products"
                )}
                <EditTemplateLongInput
                  value={sanitizeContent(
                  ...
                  onChange={(e) =>
                    handleContentChange("Statistics", "section2paragraphy", e)
                  }
                  placeholder="Edit title..."
                  className="custom-input-class text-black"
                />
              ...
              <p className="text-gray-700 mb-6 leading-relaxed max-w-2xl">
                {sanitizeContent(
                  details?.Statistics?.section2span || "Personalized Services"
                )}
                <EditTemplateLongInput
                  value={sanitizeContent(details?.Statistics?.section2span)}
                  onChange={(e) =>
                    handleContentChange("Statistics", "section2span", e)
                  }
                  placeholder="Edit text..."
                  className="custom-input-class text-black"
                />
                    ...
                    <div>
                      <h5 className="font-semibold text-white">
                        ...
                        <EditTemplateLongInput
                          ...
                          onChange={(e) =>
                            handleContentChange("Team", `header${index + 1}`, e)
                          }
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p>
              ...
              <EditTemplateLongInput
                ...
                onChange={(e) => handleContentChange("Gallery", "summary1", e)}
                placeholder="Edit summary..."
                className="custom-input-class text-black"
              />
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <input
                      type="file"
                      ref={(ref) =>
                        (fileInputRefs.current[`Gallery-image${index + 2}`] =
                          ref)
                      }
                      onChange={(e) =>
                        handleImageChange(e, "Gallery", `image${index + 2}`)
                      }
                      style={{ display: "none" }}
                    />
                  </div>
              ...
              <div className="testimonial-inner bg-white bg-opacity-10 backdrop-blur-sm p-8 lg:p-12 rounded-lg">
                <span className="sub-heading block text-primary mb-2">
                  ...
                  <EditTemplateLongInput
                    ...
                    onChange={(e) =>
                      handleContentChange("Reviews", "header1", e)
                    }
                    placeholder="Edit title..."
                    className="custom-input-class text-black"
                  />
                ...
                <h2 className="text-4xl font-bold uppercase text-white mb-4">
                  ...
                  <EditTemplateLongInput
                    ...
                    onChange={(e) =>
                      handleContentChange("Reviews", "title1", e)
                    }
                    placeholder="Edit title..."
                    className="custom-input-class text-black"
                  />
                ...
                <p className="mb-8 text-white text-opacity-80 max-w-2xl">
                  ...
                  <EditTemplateLongInput
                    ...
                    onChange={(e) =>
                      handleContentChange("Reviews", "summary1", e)
                    }
                    placeholder="Edit summary..."
                    className="custom-input-class text-black"
                  />
                    ...
                    <SwiperSlide key={index}>
                      <div className="testimonial-card bg-white p-8 rounded-lg relative">
                        ...
                        <p className="mt-4 mb-6 text-gray-700">
                          ...
                          <EditTemplateLongInput
                            value={sanitizeContent(
                              details?.Reviews?.[`summary${index + 2}`]
                            )}
                            onChange={(e) =>
                              handleContentChange(
                                "Reviews",
                        ...
                        <div className="flex gap-4 items-center">
                          ...
                          <div>
                            <h5 className="font-semibold mb-1">
                              ...
                              <EditTemplateLongInput
                                value={sanitizeContent(
                                  details?.Reviews?.[`header${index + 2}`]
                                )}
                                onChange={(e) =>
                                  handleContentChange(
                                    "Reviews",
                ...
                <div key={index}>
                  ...
                  >
                    ...
                    <EditTemplateLongInput
                      ...
                      onChange={(e) =>
                        handleContentChange("Blog", `header${index + 1}`, e)
                      }
      ...
      <footer className="bg-[#faf7f5] text-[#1c2536] text-sm leading-relaxed">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16">
          <div className="flex flex-col lg:flex-row gap-10">
            <div className="lg:w-1/3">
              ...
              <p className="mb-8 max-w-sm">
                ...
                <EditTemplateLongInput
                  value={sanitizeContent(details?.footer?.header)}
                  onChange={(e) => handleContentChange("footer", "header", e)}
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6 pb-10 border-b border-[#e6e1da]">
                <div className="lg:w-1/3 flex items-center gap-4">
                  ...
                  <h2 className="text-2xl font-semibold tracking-wide uppercase">
                    ...
                    <EditTemplateLongInput
                      value={sanitizeContent(details?.footer?.title3)}
                      onChange={(e) =>
                        handleContentChange("footer", "title3", e)
                      }
                      placeholder="Edit title..."
                      className="custom-input-class text-black"
                    />
                ...
                <div className="lg:w-2/3 grid sm:grid-cols-2 w-full text-[#585858]">
                  <div className="border-b sm:border-b-0 sm:border-r border-[#e6e1da] py-6 sm:py-0 sm:px-6">
                    ...
                    <p className="text-lg font-medium text-[#1c2536]">
                      ...
                      <EditTemplateLongInput
                        value={sanitizeContent(details?.contactUs?.heading2)}
                        onChange={(e) =>
                          handleContentChange("contactUs", "heading2", e)
                        }
                        placeholder="Edit text..."
                        className="custom-input-class text-black"
                      />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-10 pt-10">
                <div>
                  <h4 className="mb-5 font-semibold uppercase tracking-wide">
                    ...
                    <EditTemplateLongInput
                      value={sanitizeContent(details?.footer?.title1)}
                      onChange={(e) =>
                        handleContentChange("footer", "title1", e)
                      }
                      placeholder="Edit title..."
                      className="custom-input-class text-black"
                    />
                ...
                <div>
                  <h4 className="mb-5 font-semibold uppercase tracking-wide">
                    {sanitizeContent(details?.footer?.title4 || "CONTACT")}
                    <EditTemplateLongInput
                      value={sanitizeContent(details?.footer?.title4)}
                      onChange={(e) =>
                        handleContentChange("footer", "title4", e)
                      }
                      placeholder="Edit title..."
                      className="custom-input-class text-black"
                    />
                  ...
                  <ul className="space-y-5">
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        >
                          {sanitizeContent(
                            details?.footer?.paragraph9 || "(808) 555-0111"
                          )}
                          <EditTemplateLongInput
                            value={sanitizeContent(details?.footer?.paragraph9)}
                            onChange={(e) =>
                              handleContentChange("footer", "paragraph9", e)
                            }
                        ...
                        >
                          ...
                          <EditTemplateLongInput
                            value={sanitizeContent(
                              details?.footer?.paragraph10
                            )}
                            onChange={(e) =>
                              handleContentChange("footer", "paragraph10", e)
                            }
                            placeholder="Edit phone..."
                            className="custom-input-class text-black"
                          />
                    ...
                    <li className="flex gap-3">
                      ...
                      <div>
                        <p>{userDetails?.address || "3605 Parker Rd."}</p>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="mt-14 pt-6 border-t border-[#e6e1da] flex flex-wrap items-center justify-between gap-4">
            <p>
              {sanitizeContent(
                details?.footer?.privacy || "© 2025 Demure All rights reserved."
              )}
