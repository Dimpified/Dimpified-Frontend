...
const BarberLanding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Dimpified for Barbers </title>
        <meta name="description" content="Be among the top 1% of barbers" />
        <meta property="og:title" content=" Dimpified for Barbers" />
        <meta
          property="og:description"
          content="Be among the top 1% of barbers"
        />
      </Helmet>
          ...
          <div className="flex flex-col h-full  py-4 px-4 lg:px-24">
            <div className="flex flex-wrap items-end justify-center mb-5 text-center md:text-start">
              <div className="xl:w-5/12 lg:w-6/12 md:w-10/12 mb-4">
                <h3 className="bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ffa600] bg-clip-text text-transparent md: md:text-4xl text-3xl  text-3xl font-medium mb-1 tracking-tighter">
              ...
              <div className="self-end mt-10 lg:mt-0">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Manage appointments and reduce no-shows with an
              ...
              <div className="self-end mt-10">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Increase sales and get paid with our fluid payment
                      gateways.
                    </p>
                    <span className="block w-16 h-0.5 bg-gray-800"></span>
                  </div>
              ...
              <div className="relative h-full">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full lg:h-auto">
                  ...
                  <div className="lg:w-6/12 md:w-10/12 py-10 px-8">
                    ...
                    <h1 className="text-3xl lg: md:text-4xl  font-normal tracking-tight text-dark mb-4">
                    ...
                    <p className="text-dark text-lg lg:w-4/5 mb-6">
                      ...
                      digital storefront. With our software, you can easily
                      create a professional site to showcase your services,
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    ...
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      ...
                      manage your schedule from your dashboard, ensuring that
                      your chair is always full.
                    </p>
            ...
            <div className="flex items-center justify-center text-center mb-6">
              <div className="xl:w-10/12">
                <h2 className="font-alt  md:text-4xl text-3xl  font-normal text-gray-800 tracking-tight mb-0">
                  Lots of barbing entrepreneurs use Dimpified for their
                  business.
                </h2>
              </div>
            </div>
