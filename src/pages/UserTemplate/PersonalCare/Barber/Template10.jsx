...
const Template10 = ({ details, subdomain, userDetails }) => {
        ...
        <div className="flex flex-col h-full py-4 px-4 lg:px-20">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-800 inline-block ml-2">
              We're dedicated to empowering people to look and feel fantastic.
            </p>
          </div>
        </div>
      </section>
                ...
                >
                  ...
                  >
                    <div className="text-lg flex items-baseline w-full">
                      ...
                      <div className="text-dark-gray">{getCurrencySymbol(currency)}{item.price}</div>
                    </div>
            ...
            <div className=" relative px-5 sm:px-0 text-center md:text-left">
              ...
              >
                ...
                <SwiperSlide>
                  <div className="text-center">
                    <span className="text-xl ov leading-8 block mb-6">
                      {sanitizeContent(details.Reviews.summary1)}
                    </span>
                    <span className="text-lg font-bold text-gray-700 py-3">
                      {sanitizeContent(details.Reviews.title1)}
                    </span>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="text-center">
                    <span className="text-xl leading-8 block mb-2">
                      {sanitizeContent(details.Reviews.summary2)}
                    </span>
                    <span className="text-lg font-bold text-gray-700 py-3">
                      {sanitizeContent(details.Reviews.title2)}
                    </span>
                  </div>
                </SwiperSlide>
                {/* End testimonial item */}
                ...
                <SwiperSlide>
                  <div className="text-center">
                    <span className="text-xl leading-8 block mb-2">
                      {sanitizeContent(details.Reviews.summary3)}
                    </span>
                    <span className="text-lg font-bold text-gray-700 py-3">
                      {sanitizeContent(details.Reviews.title3)}
                    </span>
                  </div>
                </SwiperSlide>
                <div
