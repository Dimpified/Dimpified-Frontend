        ...
        <div className="flex flex-col h-full  py-4 px-6 lg:px-32 md:px-12 md:flex-row items-center gap-10">
          ...
          <div className="md:w-1/2">
            ...
            <ul className="space-y-3">
              {[
                { display: details?.aboutUs?.text2, field: "text2" },
                {
                  display: details?.aboutUs?.buttonText1,
                  field: "buttonText1",
                },
                {
                  display: details?.aboutUs?.buttonText2,
                  field: "buttonText2",
                },
              ].map((item, index) => (
                <li key={index} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-gray-700">
                      {sanitizeContent(item.display)}
                    </p>
                    <EditTemplateLongInput
                      value={
                        sanitizeContent(details?.aboutUs?.[item.field]) || ""
                      }
                      onChange={(event) =>
                        handleContentChange("aboutUs", item.field, event)
                      }
                ...
                <div key={index} className="p-6 text-center">
                  ...
                  <div className="flex justify-center items-center mt-6">
                    ...
                    <div className="ml-4 text-left">
                      <h6 className="font-bold text-lg">{testimonial.name}</h6>
