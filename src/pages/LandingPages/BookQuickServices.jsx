...
import Logo from "../../../src/assets/dimp-blue.png";
...
const Header = ({ businessName = "Smile Dental Clinic" }) => {
...
const BookQuickServices = () => {
  ...
  // Mock function to simulate fetching business data
  const fetchBusinessData = async () => {
    // Replace this with your actual API call
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({ name: "Smile Dental Clinic" }); // Mock data
      }, 100);
    });
  };
  ...
  return (
    <>
      <Helmet>
        <title>Book our Services - Dimpified </title>
        <meta name="description" content="Book Instant Services" />
        <meta property="og:title" content="Book Instant Services - Dimpified" />
...
export default BookQuickServices;
