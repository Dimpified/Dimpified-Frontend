...
import Logo from "./images/DIMPwhitelogo.png";
...
const DarkNavbar = () => {
  ...
  return (
    <nav className="font-sen bg-primary4 px-6 py-2 fixed top-0 left-0 w-full z-50">
      <div className="flex flex-wrap items-center justify-between lg:px-24 py-1">
        ...
        <div className="flex items-center md:order-2 space-x-1 md:space-x-3 rtl:space-x-reverse">
          <Link
            to="/auth/login"
            className="btn btn-outline-primary md:block hidden text-white text-sm px-4 py-2 md:px-5 md:py-2.5 rounded-lg flex items-center justify-between border-2 border-white hover:bg-primary3 hover:text-white transition"
          >
            Sign In
          </Link>
          <button
        ...
        <div
          className={`fixed inset-y-0 left-0 w-64 bg-primary4 z-50 transform ${
          ...
          <ul className="flex flex-col px-4 space-y-4 font-medium">
            <li>
              <Link
                ...
                className="block py-2 text-gray-50 hover:text-primary3"
              >
                Features
              </Link>
            </li>
            ...
            <li className="relative">
              <button
                ...
                className="flex items-center justify-between w-full py-2 font-medium text-gray-50 hover:text-primary3"
              >
                Use Cases
                <svg
                ...
                <ul className="pl-4 mt-2 space-y-2">
                  <li>
                    <Link
                      to="/barbers"
                      onClick={toggleMenu}
                      className="block py-1 text-gray-300 hover:text-primary3"
                    >
                      Barbers
                    </Link>
                  </li>
            ...
            <li className="mt-4">
              <Link
                to="/auth/login"
                onClick={toggleMenu}
                className="btn btn-outline-primary w-full text-white text-sm px-4 py-3 rounded-lg flex items-center justify-center border border-white hover:bg-primary3 hover:text-white transition"
              >
                Sign In
              </Link>
            </li>
          ...
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
            <li>
              <Link
                ...
                className="block py-2 px-3 text-gray-50 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary3 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
              >
                Features
              </Link>
            </li>
            ...
            >
              <button
                onClick={() => toggleDropdown("useCases")}
                className="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-50 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-primary3 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"
              >
                Use Cases
                <svg
                  className="w-2.5 h-2.5 ms-3"
