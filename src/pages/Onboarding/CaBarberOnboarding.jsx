...
const dentistsBarberOnboarding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          property="og:title"
          content="dentistsBarberOnboarding Us - My App"
        />
        <meta
      ...
      <div className="font-sen">
        ...
        <section className=" lg:px-32  pb-10 bg-cover bg-center">
          <div className="mt-24 bg-purple-100 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            ...
            <p className="mb-8">
              Barbers across Canada & 20+ countries are turning their chairs
...
export default dentistsBarberOnboarding;
