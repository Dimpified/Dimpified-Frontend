...
// Import images
import SpaImg from "./images/spaimage.jpg";
import SpaBooking from "./images/spamoney.jpg";
import SpaMoney from "./images/hairdresser-money.jpg";
import SpaCustomer from "./images/spacustomer.jpg";
...
const reviews = [
  {
    name: "Aisha, Lagos",
    text: "This platform has completely changed my spa business! Clients can easily book appointments online, and my schedule is now more organized. My revenue has increased significantly!",
  },
  {
    name: "Fatima, Abuja",
    text: "Setting up my spa website was effortless. Now, customers can browse my treatments, book sessions instantly, and even leave reviews. My spa has never been busier!",
  },
  {
    name: "Chioma, Port Harcourt",
    text: "The analytics feature is a game-changer! I now understand which treatments are most popular and adjust my services accordingly. This platform is a must-have for spa owners!",
  },
];
...
const SpaLanding = () => {
  ...
  return (
    ...
    >
      {" "}
      <Helmet>
        <title>Dimpified For Spa & Wellness Centres </title>
        <meta
          name="description"
          content="Your luxury spa service deserves fast, reliable upfront payments"
        />
        <meta
          property="og:title"
          content=" Dimpified For Spa & Wellness Cenres"
        />
        <meta
      ...
      <div className="font-jak">
            ...
            <div className="flex flex-col md:flex-row items-center h-full">
              <div className="md:w-1/2 px-3 flex flex-col justify-center h-full">
                <h1 className="lg:text-pXXL text-[2.5rem] text-dark font-normal leading-tight mb-6">
                  <span>Your luxury spa service deserves</span> <br />
                  <span className="font-bold bg-gradient-to-r from-[#2a004e]  via-[#c62300]    via-[#f14a00] to-[#500073]  text-transparent bg-clip-text">
                    fast, reliable upfront payments
                  </span>
                </h1>
                <p className="text-lg  text-dark leading-relaxed mb-8 w-4/5">
                  Get a website. Set services and prices. Get booked. Get your
                  money first. Relax customers.
                </p>
                <div className="flex flex-col md:flex-row gap-4">
                  <Link to="/pricing">
                    <button
                      target="_blank"
                      className="btn w-full  hover:bg-gradient-to-l from-[#2a004e]  via-[#c62300]    via-[#f14a00] to-[#500073] bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201] text-white py-4 lg:px-6 px-3 rounded-lg flex items-center justify-center hover:bg-white transition"
                    >
                  ...
                  <Link to="/spa-near-me">
                    <button className="btn hover:text-white hover:bg-gradient-to-l w-full text-center from-[#4f2683]  via-[#9966cc] to-[#ff8201] border-2 border-primary3 text-primary3 py-4 lg:px-6 px-3 rounded-lg flex items-center justify-center transition">
                      <span className="mr-3">Find a spa near me</span>
                      <FaArrowRight />
                    </button>
                  </Link>
                </div>
          ...
          <div className="flex flex-col h-full py-4 px-4 lg:px-24">
            <div className="flex flex-wrap items-end justify-center mb-5 text-center md:text-start">
              <div className="xl:w-6/12 lg:w-6/12 md:w-10/12 mb-4">
                <h3 className="bg-gradient-to-r from-blue-500 via-orange-500 to-pink-500 bg-clip-text text-transparent md:text-4xl text-3xl  font-medium mb-1 tracking-tight">
                  Your expertise in wellness and relaxation deserves seamless
                  bookings and secured payments.
                </h3>
              </div>
              <div className="xl:w-5/12 lg:w-6/12 md:w-10/12 xl:ml-auto">
                <p className="w-11/12 md:w-4/5 mx-auto md:mx-0">
                  You’ve created a sanctuary for self-care—now let us help you
                  run your business smoothly. Our software allows spa owners to
                  set treatment options, manage bookings effortlessly, and
                  receive payments in advance, so you can focus on delivering
                  tranquility without financial worries.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-10 relative lg:mt-16">
                ...
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    <span className="block text-xl font-normal mb-2">
                      Build your spa’s online presence
                    </span>
                    <p className="mb-2">
                      Create a professional website showcasing your services,
                      ambiance, and client testimonials.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="self-end mt-10 lg:mt-0">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    <span className="block text-xl font-normal mb-2">
                      Set treatment menus and pricing
                    </span>
                    <p className="mb-2">
                      List services like massages, facials, and aromatherapy,
                      with customizable pricing and duration.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="self-start">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Let clients schedule their self-care sessions with ease,
                      while you stay in control of your calendar.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="self-end mt-10">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Secure earnings with upfront payments, reducing
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center">
                      ...
                      <div className="flex items-start mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Beautiful, easy-to-use templates for an elegant online
                          presence.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Display your spa treatments in a stunning visual
                          layout.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Showcase your service menu and pricing for effortless
                          bookings.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Share customer testimonials to build trust and
                          credibility.
                        </p>
                      </div>
                    </div>
        ...
        <section className="font-jak z-10">
          <div className="flex flex-col h-full py-4 px-4 lg:px-24">
            <div className="bg-green-50 rounded-3xl py-10 px-6 lg:py-24">
              <div className="relative h-full">
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-1 lg:order-2 mb-4 lg:w-6/12 lg:mb-0">
                    <img
                      ...
                      alt="Spa Appointment Management"
                    />
                  </div>

                  {/* Content Section */}
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    <span className="font-bold text-sm py-2 px-5 mb-3 inline-block uppercase text-dark bg-gradient-to-r from-green-100 to-transparent rounded-full">
                      Stress-Free Spa Scheduling
                    </span>
                    <h1 className="font-normal md:text-4xl text-3xl  text-dark mb-3">
                      Simplify Your Spa Appointments
                    </h1>
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      No more scheduling headaches. Our user-friendly booking
                      system lets clients reserve spa treatments online, make
                      secure payments in advance, and receive instant
                      confirmations. Keep your schedule organized and your spa
                      running smoothly with a seamless management dashboard.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Clients can book spa treatments anytime, 24/7.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Effortlessly manage bookings from a central dashboard.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Customize services and schedules to suit your spa’s
                          needs.
                        </span>
                      </div>
                    </div>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-0">
              ...
              <div className="lg:w-6/12 md:w-10/12 py-10">
                ...
                <p className="text-md text-dark mb-4 leading-relaxed w-11/12 lg:w-full">
                  Build lasting relationships with your spa clients. Track their
                  preferences, favorite treatments, and visit history to provide
                  personalized experiences that keep them coming back.
                </p>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">
                    Store client details and treatment history in one place.
                  </span>
                </div>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">
                    Analyze trends and tailor services based on client
                    preferences.
                  </span>
                </div>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">
                    Engage clients with promotions and personalized offers.
                  </span>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-lg text-dark">
                    Offer loyalty programs to reward your most dedicated
                    clients.
                  </span>
                </div>
              </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-1 lg:order-2 lg:w-5/12 mb-4 lg:mb-0 lg:pr-16">
                    <img
                      ...
                      alt="Increase Your Spa Earnings"
                    />
                  </div>
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-16">
                    ...
                    <h1 className="font-normal md:text-4xl text-3xl  text-dark mb-3">
                      Get Paid Before Your Clients Step In
                    </h1>
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      Ensure a steady revenue stream with prepayment options and
                      seamless booking. Allow your clients to schedule spa
                      treatments, pay in advance, and receive instant
                      confirmations. Focus on providing relaxation while we take
                      care of your appointments and payments.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Offer multiple services like massages, facials, and
                          wellness treatments.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Secure payment processing ensures smooth transactions.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Create special packages & membership plans to boost
                          customer loyalty.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Withdraw earnings quickly and conveniently,
                          hassle-free.
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      <span>Start Growing Your Spa Today!</span>
                      <BsArrowRight className="ml-2" />
                    </button>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-center text-center mb-6">
              <div className="xl:w-10/12">
                <h2 className="font-alt  md:text-4xl text-3xl  font-normal text-gray-800 tracking-tight mb-0">
                  Lots of Spa businesses use Dimpified for their business.
                </h2>
              </div>
            </div>
          ...
          <div className="bg-[#e926a8] py-12 px-6 lg:py-40 lg:px-20 lg:mx-20 rounded-3xl text-center">
            <div>
              <h2 className="text-4xl font-light text-white tracking-tight mb-4">
                Your Spa business just got way more easier.
              </h2>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Our platform is designed to help professional Spa
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-bold text-lg">
                            How does the booking feature benefit my Spa Artist
                            business?
                          </h3>
                          <span className="flex items-center">
                            {open ? "-" : "+"}
