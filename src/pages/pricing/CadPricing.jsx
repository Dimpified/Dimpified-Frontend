...
const CadPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["$24.99", "$22.49", "$19.99", "$17.49"],
    Plus: ["$39.99", "$35.99", "$31.99", "$27.99"],
    Pro: ["$74.99", "$67.49", "$59.99", "$52.49"],
    Extra: ["$124.99", "$112.49", "$99.99", "$87.49"],
  };
  ...
  const addOns = [
    {
      ...
      prices: ["$24.99", "$39.99", "$74.99", "$124.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["$39.99", "$39.99", "$39.99", "$39.99"],
    },
    {
      name: "Multi-Language",
      prices: ["$74.99", "$74.99", "$74.99", "$74.99"],
    },
  ];
