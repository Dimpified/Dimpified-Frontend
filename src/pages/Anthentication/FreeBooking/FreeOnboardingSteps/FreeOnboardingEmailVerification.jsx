// pages/auth/FreeOnboardingEmailVerification.jsx
...
const FreeOnboardingEmailVerification = () => {
  ...
  return (
    <FreeOnboardingLayout currentStep={2} rightImage={OTPImage}>
...
export default FreeOnboardingEmailVerification;
