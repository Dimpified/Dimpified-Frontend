...
const BlankTemplate = ({ userDetails }) => {
  // List of images
  const images = [
    "https://dummyimage.com/400x400/aaa/fff",
    "https://dummyimage.com/400x400/aaa/fff",
    "https://dummyimage.com/400x400/aaa/fff",
    "https://dummyimage.com/400x400/aaa/fff",
    "https://dummyimage.com/400x400/aaa/fff",
  ...
  return (
    <Fragment>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(https://dummyimage.com/1280x720/aaa/aaa)`,
          ...
          <div className="flex flex-wrap items-center mb-12 sm:mb-10">
            ...
            <div className="font-jak w-full xl:w-5/12 lg:w-6/12 mt-4 xl:mt-6 md:mt-8 xs:mt-10">
              ...
              <p className="w-11/12 xl:w-full mb-8 sm:mb-6">
                You business about or description text here You business about
                or description text here You business about or description text
                here You business about or description text here You business
                about or description text here
              </p>
        ...
        <div className="flex flex-col h-full px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 text-center gap-8 mt-10">
            <div>
              ...
              <p className="text-yellow-950">Stats Description</p>
            </div>
            <div>
              <h2 className="font-semibold text-3xl  text-yellow-950 m-0">
              ...
              >
                ...
                >
                  <div className="text-lg flex items-baseline w-full">
                    ...
                    <div className="text-dark-gray">#Service Price</div>
                  </div>
      ...
      >
        ...
        <div className="container mx-auto max-w-full lg:max-w-screen-lg">
                ...
                <SwiperSlide>
                  <div className="text-center">
                    <span className="text-xl leading-8 block mb-2">
                      Testimonial details Testimonial details Testimonial
          ...
          <div className="flex flex-wrap">
            <div className="lg:w-1/2 s:w-10/12 pb-7 sm:pb-10 px-6">
              <span className="font-lime text-base uppercase text-dark   font-bold mb-2 inline-block">
                Short description about contact
              </span>
      ...
      <footer className="beauty font-jak px-4 bg-gradient-to-r from-[#2c3846] via-[#333945] to-[#5b5857] ">
        <div className="flex flex-col lg:flex-row justify-center lg:px-32 pt-[55px] pb-[55px] sm:pt-[40px] sm:pb-[40px] text-center sm:text-center lg:text-left">
          ...
          <div className="lg:w-1/4 md:w-1/2 sm:w-full mb-6">
            ...
            <p className="primary-font  leading-[30px] text-white">Text here</p>
          </div>

          {/* Need Support */}
          <div className="lg:w-1/4 md:w-1/2 sm:w-full mb-6">
            <span className="primary-font block text-white  text-sm mb-[5px] uppercase  font-semibold">
              Footer heading 2 - Phone
            </span>
          ...
          <div className="lg:w-1/4 md:w-1/2 sm:w-full mb-6">
            ...
            <div className="elements-social text-2xl social-icon-style-09">
              <ul className="medium-icon light flex justify-center lg:justify-start">
                <li>
                  <a
                    className="facebook"
                    href="https://www.facebook.com/"
                    ...
                    rel="noopener noreferrer"
                  >
                    <i className="fa-brands fa-facebook-f mr-3 text-white"></i>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <i className="fa-brands fa-instagram mr-3 text-white"></i>
                  </a>
                </li>
                <li>
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <i className="fa-brands fa-twitter mr-3 text-white"></i>
                  </a>
                </li>
              </ul>
            </div>
