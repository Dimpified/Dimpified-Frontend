...
const LiberiaPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["$9.99", "$8.99", "$7.99", "$6.99"],
    Plus: ["$17.99", "$16.19", "$14.39", "$12.59"],
    Pro: ["$29.99", "$26.99", "$23.99", "$20.99"],
    Extra: ["$49.99", "$44.99", "$39.99", "$34.99"],
  };
  ...
  const addOns = [
    {
      ...
      prices: ["$9.99", "$17.99", "$29.99", "$49.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["$17.99", "$17.99", "$17.99", "$17.99"],
    },
    {
      name: "Multi-Language",
