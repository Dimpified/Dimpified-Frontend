...
const MalaysiaPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["RM69", "RM62", "RM55", "RM48"],
    Plus: ["RM119", "RM107", "RM95", "RM83"],
    Pro: ["RM199", "RM179", "RM159", "RM139"],
    Extra: ["RM329", "RM296", "RM263", "RM230"],
  };
 ...
 const planFeatures = {
  ...
  const addOns = [
    {
      ...
      prices: ["RM69", "RM119", "RM199", "RM329"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["RM119", "RM119", "RM119", "RM119"],
    },
    {
      name: "Multi-Language",
      prices: ["RM199", "RM199", "RM199", "RM199"],
    },
  ];
  ...
  const loanOptions = [
    {
      name: "Loan Offer",
      values: ["Up to RM1,000", "Up to RM3,000", "Up to RM10,000", "Up to RM50,000"],
    },
    {
      name: "Minimum Monthly Volume",
      values: ["RM3,000+", "RM5,000+", "RM10,000+", "RM30,000+"],
    },
    {
      name: "Interest Rate",
...
export default MalaysiaPricing;