...
const category = [
  {
    value: "barber-shop",
    image: "https://gfa-tech.com/dimp-template-images/barber/barb.jpg",
    label: "Barber Shop",
  ...
  },
  {
    ...
    image: "https://gfa-tech.com/dimp-template-images/spa/herospa.jpg",
    label: "Spa Centre",
    link: "/spa-near-me",
  },
  {
    value: "gym-centres",
    image: "https://gfa-tech.com/dimp-template-images/gym/gym1.jpg",
    label: "Gym Centres",
    link: "/gym-near-me",
  },
  {
...
const testimonials = [
  {
    ...
    role: "Entrepreneur",
    img: "https://gfa-tech.com/dimp-template-images/barber/instructor1.jpg",
    review:
  ...
  },
  {
    name: "Fatima Bello",
    role: "Banker",
    img: "https://gfa-tech.com/dimp-template-images/barber/instructor3.jpg",
    review:
  ...
  },
  {
    ...
    img: "https://gfa-tech.com/dimp-template-images/barber/instructor4.jpg",
    review:
  ...
  },
  {
    name: "Amaka Ozo",
    role: "Event Planner",
    img: "https://gfa-tech.com/dimp-template-images/barber/instructor2.jpg",
    review:
...
const CustomerLanding = ({ subdomain }) => {
  ...
  const featuredMerchantsIds = [
    "67a52626da89af8165a4d44c",
    "67b5e4ca6b0ce1a31d6d867f",
    "678ce7f73e64dd6522eeda92",
    "67a5e33cda89af8165a4e50c",
    "67c5a71c72baf5faeb104945"
    ...
    >
      <div className="font-sen">
        ...
        <div className="p-8 px-5 lg:px-32  md:px-16">
          ...
          >
            <img src={TrendingBG} className="w-80 opacity-20" alt="" />
          </div>
            ...
            <div className="relative ">
              ...
              >
                {currentEcosystems
                  .filter(
                    (ecosystem) =>
                      featuredMerchantsIds.includes(ecosystem._id) 
                  )
                  .map((ecosystem, index) => (
