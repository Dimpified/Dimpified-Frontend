// pages/auth/FreeOnboardingPersonalInfo.jsx
...
const FreeOnboardingPersonalInfo = () => {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (newCreatorRegister.fulfilled.match(resultAction)) {
        ...
        if (userStep === 1) {
          navigate("/free/auth/email-verification");
        } else if (userStep === 2) {
  ...
  return (
    <FreeOnboardingLayout
      ...
      backDisabled={false}
    >
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
...
export default FreeOnboardingPersonalInfo;
