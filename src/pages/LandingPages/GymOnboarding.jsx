...
const reviews = [
  ...
  {
    name: "Moses, Gym – Kenya",
    text: "I stopped juggling WhatsApp and Instagram messages. Dimpified lets members book online, pay upfront, and get reminders—automatically.",
  },
  {
    name: "Ade, Abuja",
    text: "Building a website was so easy. Now, members can see my work and book appointments online. My business has never been better!",
  },
  {
  ...
  {
    name: "Ngozi, Enugu",
    text: "I love how easy it is to schedule appointments and send reminders to my members. It has saved me so much time and reduced no-shows drastically!",
  },
  {
    name: "Bola, Ibadan",
  ...
  {
    name: "Tunde, Kano",
    text: "Setting up my profile and services was straightforward. Now I get bookings directly from the app, and I can focus on delivering quality service to my members.",
  },
  {
    name: "Esther, Benin City",
    text: "The automated reminders have been a lifesaver. My members appreciate the convenience, and I’ve seen an increase in my appointment retention rates.",
  },
  {
    name: "Ibrahim, Sokoto",
  ...
  {
    name: "Grace, Uyo",
    text: "The support team is amazing! They helped me set up everything quickly, and now I have a professional online presence that attracts new members every week.",
  },
  {
    name: "Chika, Owerri",
    text: "The marketing tools included in this software have helped me reach more people and keep my existing members engaged. I’m very happy with the results!",
  },
];
  ...
  return (
    ...
    >
      <Helmet>
        ...
        />
        <meta property="og:title" content="GymOnboarding Us - My App" />
        <meta
            ...
            <div className="flex flex-col md:flex-row items-center h-full">
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                ...
                <p className="text-base md:text-lg text-dark leading-relaxed mb-8 max-w-lg">
                  Trusted by gyms across Nigeria. Subscription required —
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
            ...
            <div className="bg-purple-100 text-gray-800 rounded-2xl p-6 flex flex-col justify-between">
              ...
              <p className="mb-4 md:text-lg text-sm">
                We're proudly Nigerian. Our team supports you every step of the
                way — from setup to scale-up.
              </p>
            </div>
          </div>
        </section>
                ...
                >
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      ...
                      We went from 12 to 43 paying members in 60 days. Dimpified
                      made it easy to go online
                      <FaQuoteRight className=" text-2xl text-primary3 " />
                      <br />— <strong>Coach Ayo, PowerMax Gym, Ibadan</strong>
                    </p>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      <FaQuoteLeft className="text-2xl text-primary3 " />
                      Our bookings doubled the month we launched our new site.
                      <FaQuoteRight className="text-2xl text-primary3 " />
                      <br />— <strong>Blessing Fit, Abuja</strong>
                    </p>
                  </SwiperSlide>
                </Swiper>
              </div>
        ...
        <section className="bg-primary3  bg-cover bg-center text-white">
          <div className="mt-24 bg-primary3 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            <h2 className="text-2xl md:text-4xl font-jak  font-semibold leading-snug mb-4">
              Join Nigeria’s Digital Fitness Revolution
            </h2>
            <p className="mb-8">
