...
const KenyaPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["KES 1,499", "KES 1,349", "KES 1,199", "KES 1,049"],
    Plus: ["KES 2,999", "KES 2,699", "KES 2,399", "KES 2,099"],
    Pro: ["KES 4,999", "KES 4,499", "KES 3,999", "KES 3,499"],
    Extra: ["KES 7,999", "KES 7,199", "KES 6,399", "KES 5,599"],
  };
  ...
  const addOns = [
    {
      ...
      prices: ["KES 1,499", "KES 2,999", "KES 4,999", "KES 7,999"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["KES 2,999", "KES 2,999", "KES 2,999", "KES 2,999"],
    },
    {
      name: "Multi-Language",
      prices: ["KES 4,999", "KES 4,999", "KES 4,999", "KES 4,999"],
    },
  ];
  ...
  const loanOptions = [
    {
      name: "Loan Offer",
      values: ["Up to KES 500", "Up to KES 1,500", "Up to KES 5,000", "Up to KES 25,000"],
    },
    {
      name: "Minimum Monthly Volume",
      values: ["KES 1,500+", "KES 2,500+", "KES 5,000+", "KES 15,000+"],
    },
    {
      name: "Interest Rate",
