...
const CustomerNavbar = () => {
  ...
  return (
    <nav
      className={`font-sen px-6 py-2 lg:px-24 fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        ...
        >
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
            ...
            >
              ...
              <Link
                to="/merchants"
                className="btn mb-3 w-full btn-outline-primary justify-center block md:hidden text-primary3 text-sm px-4 py-3 md:px-5 md:py-2.5 rounded-lg flex items-center border-2 border-primary3 hover:bg-primary3 hover:text-white transition"
              >
                For Businesses
              </Link>
              {/* <Link
