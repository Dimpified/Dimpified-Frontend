...
const reviews = [
  {
    ...
    text: "Since using this software, my bookings have doubled, and I’ve seen a significant increase in repeat patients. The ability to manage everything from my phone is a game-changer!",
  },
  {
    name: "Moses, Dentist – Kenya",
    text: "I stopped juggling WhatsApp and Instagram messages. Dimpified lets patients book online, pay upfront, and get reminders—automatically.",
  },
  {
    name: "Ade, Abuja",
    text: "Building a website was so easy. Now, patients can see my work and book appointments online. My business has never been better!",
  },
  {
  ...
  {
    name: "Femi, Lagos",
    text: "The insights I get from the analytics tools have helped me understand my patients better and tailor my services to their needs. Highly recommended!",
  },
  {
  ...
  {
    name: "Ngozi, Enugu",
    text: "I love how easy it is to schedule appointments and send reminders to my patients. It has saved me so much time and reduced no-shows drastically!",
  },
  {
    name: "Bola, Ibadan",
  ...
  {
    name: "Tunde, Kano",
    text: "Setting up my profile and services was straightforward. Now I get bookings directly from the app, and I can focus on delivering quality service to my patients.",
  },
  {
    name: "Esther, Benin City",
    text: "The automated reminders have been a lifesaver. My patients appreciate the convenience, and I’ve seen an increase in my appointment retention rates.",
  },
  {
    name: "Ibrahim, Sokoto",
  ...
  {
    name: "Grace, Uyo",
    text: "The support team is amazing! They helped me set up everything quickly, and now I have a professional online presence that attracts new patients every week.",
  },
  {
    name: "Chika, Owerri",
    text: "The marketing tools included in this software have helped me reach more people and keep my existing patients engaged. I’m very happy with the results!",
  },
];

const USDentistOnboarding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        />
        <meta property="og:title" content="USDentistOnboarding Us - My App" />
        <meta
        ...
        <section className="py-6 px-6 md:px-12  md:py-24 lg:px-40 bg-gray-50 text-gray-800 bg-cover bg-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            ...
            <div className="bg-teal-100 rounded-2xl p-6">
              ...
              <p className="text-gray-800 mb-4 md:text-lg text-sm">
                Get a custom link like yourdentalclinic.dimpified.com in minutes.
              </p>
            </div>
          </div>
...
"
        ...
        <section className=" lg:px-32  pb-10 bg-cover bg-center">
          <div className="mt-24 bg-teal-100 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            ...
            <p className="mb-8">
              Dentists across the United States & 20+ countries are turning their clinics
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          Your patients can pay you even when you’re offline.
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-semibold text-lg">
                            Can I manage multiple dentists in one account?
                          </h3>
                          <span className="flex items-center">
                            {open ? "-" : "+"}
                          </span>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          You are guaranteed 24/7 Customer Support
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
...
export default USDentistOnboarding;
