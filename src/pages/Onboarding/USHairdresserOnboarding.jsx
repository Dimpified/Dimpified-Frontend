...
const reviews = [
  {
    name: "Tasha’s Hair Studio, Atlanta, GA",
    text: "Since I started using this app, I don’t stress about slow days anymore—my calendar stays fully booked, week after week.",
  },
  {
    name: "Bri Styles, Houston, TX",
    text: "I shared my booking link on Instagram and got 7 new clients in just one week. It made a huge difference in my business!",
  },
  {
    name: "Alyssa, Mobile Stylist – Los Angeles, CA",
    text: "Creating a website was super simple. Now, clients can browse my work, pick a service, and book online—no DMs needed.",
  },
  {
    name: "Keisha, Hair Artist – Miami, FL",
    text: "It’s the only platform I’ve found that really gets the hair industry. Everything’s built to make our lives easier—from setup to scheduling.",
  },
  {
    name: "Nina, Salon Owner – Brooklyn, NY",
    text: "The analytics helped me realize which services were in high demand. I adjusted my pricing and saw a real boost in revenue.",
  },
  {
    name: "Jade, Stylist – Chicago, IL",
    text: "Scheduling is a breeze now. Clients get automatic reminders, and I save hours every week not chasing people down.",
  },
  {
    name: "Maya, Independent Stylist – Phoenix, AZ",
    text: "From managing appointments to collecting payments, this software handles everything. It’s like having a virtual assistant for my salon.",
  },
];

const USHairdresserOnboarding = () => {
  ...
  const steps = [
    {
      number: "01",
      title: "Choose a Plan",
      description: "starting from just $19.99/month",
    },
    {
      number: "02",
      ...
      <div className="font-sen">
        ...
        <section className=" lg:px-32  pb-10 bg-cover bg-center">
          <div className="mt-24 bg-purple-100 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            ...
            <p className="mb-8">
              Hairdressers across the US are turning their skills into digital
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          sent directly to your American bank account.
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
...
export default USHairdresserOnboarding;
