...
const ZimbabwePricing = () => {
  ...
  const subscriptionData = {
    Lite: ["$14.99", "$13.49", "$11.99", "$10.49"],
    Plus: ["$24.99", "$22.49", "$19.99", "$17.49"],
    Pro: ["$44.99", "$40.49", "$35.99", "$31.49"],
    Extra: ["$74.99", "$67.49", "$59.99", "$52.49"],
  };
  ...
  const addOns = [
    {
      ...
      prices: ["$14.99", "$24.99", "$44.99", "$74.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["$24.99", "$24.99", "$24.99", "$24.99"],
    },
    {
      name: "Multi-Language",
      prices: ["$44.99", "$44.99", "$44.99", "$44.99"],
    },
  ];
...
export default ZimbabwePricing;
