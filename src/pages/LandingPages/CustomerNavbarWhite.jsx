...
const CustomerNavbar = () => {
  ...
  return (
    <nav className="font-sen px-6 py-2 lg:px-28 fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-white ">
      <div className="flex flex-wrap items-center justify-between  py-1">
        ...
        >
          ...
          {/* <h1 className="font-jost tracking-wide bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201]  text-2xl text-transparent bg-clip-text ">
            <span className="font-jost bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201] font-bold text-2xl text-transparent bg-clip-text">
              D
            </span>
            <span className="font-sans bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201] font-medium text-2xl text-transparent bg-clip-text">
              impified
            </span>
          </h1> */}
        </Link>
        <div className="flex items-center md:order-2 space-x-1 md:space-x-3 rtl:space-x-reverse">
          <Link
            to="/merchants"
            className="btn btn-outline-primary md:block hidden text-primary3 text-sm px-4 py-2 md:px-5 md:py-2.5 rounded-xl flex items-center justify-between border-2 border-primary3 hover:bg-primary3 hover:text-white transition"
          >
            For Businesses
          </Link>
          {/* <Link
        ...
        >
          <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
            ...
            >
              ...
              {/* <div
                className={`absolute z-50 grid lg:w-[200px] grid-col-1 w-full gap-4 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 dark:bg-gray-700 transition-all duration-300 ${
              ...
              <Link
                to="/merchants"
                className="btn mb-3 w-full btn-outline-primary justify-center block md:hidden text-primary3 text-sm px-4 py-3 md:px-5 md:py-2.5 rounded-lg flex items-center border border-primary3 hover:bg-primary3 hover:text-white transition"
              >
                For Businesses
              </Link>
              {/* <Link
                to="/auth/login"
                className="md:hidden w-full text-center justify-center block bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201]  hover:bg-gradient-to-l from-[#4f2683]  via-[#9966cc] to-[#ff8201]  text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-3 md:px-5 md:py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Sign In
              </Link> */}
            </li>
