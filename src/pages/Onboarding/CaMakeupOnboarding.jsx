...
import MakeupRight from "./images/barberright.jpg";
...
const reviews = [
  {
    ...
    text: "Since using this platform, my bookings have doubled, and I’ve seen a big increase in returning clients. Managing everything from my phone is a total game-changer!",
  },
  {
    name: "Brianna, Makeup Artist – Vancouver, BC",
  ...
  {
    name: "Olivia, Montreal, QC",
    text: "Building my site was super easy. New clients can browse my portfolio and book online anytime. My business is growing fast!",
  },
  {
    name: "Carmen, Makeup Artist – Calgary, AB",
    text: "This is the first tool I’ve used that truly understands service-based businesses. It was easy to set up and makes my daily work effortless.",
  },
  {
    name: "Alyssa, Ottawa, ON",
    text: "The insights I get from the analytics help me track client trends and tailor my services. It’s made a real difference!",
  },
  {
    name: "Rachel, Beauty Coach – Edmonton, AB",
    text: "As a beauty coach, this platform helped me bring my services online and triple my client base. Everything just works!",
  },
  {
    name: "Taylor, Mississauga, ON",
    text: "I love how easy it is to schedule clients and send automatic reminders. It’s saved me so much time and reduced no-shows!",
  },
  {
    name: "Danielle, Winnipeg, MB",
    text: "From product tracking to managing clients, this software has transformed how I run my makeup studio. I’m never going back!",
  },
  {
    name: "Megan, Halifax, NS",
    text: "Setting up my profile and listing my services was quick and simple. I now get booked directly through the app—no more back-and-forth messages.",
  },
  {
    name: "Vanessa, Regina, SK",
    text: "The automated reminders have been a lifesaver. My clients love the convenience, and my calendar stays full!",
  },
  {
    name: "Nicole, Surrey, BC",
    text: "I didn’t think I could manage my entire beauty business from one app—but this platform proves otherwise. It’s sleek, efficient, and saves me hours every week.",
  },
  {
    name: "Sierra, Brampton, ON",
    text: "The support team is amazing! They helped me get everything set up, and now I’ve got a professional online presence that brings in new clients regularly.",
  },
  {
    name: "Madison, St. John's, NL",
    text: "The built-in marketing tools help me stay top of mind with clients and grow my reach—without hiring outside help. Love it!",
  },
];

const CaMakeupOnboarding = () => {
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          $24.99/month. Your business deserves more than “free.”
...
export default CaMakeupOnboarding;
