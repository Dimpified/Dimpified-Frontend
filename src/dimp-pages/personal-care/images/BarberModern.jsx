      ...
      >
        <div className="h-lvh flex flex-col items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="font-limelight text-[3rem] lg:text-[6rem] px-4 lg:px-48 leading-none tracking-normal text-white mb-8 md:mb-5 shadow-lg">
          ...
          <div className="flex flex-wrap items-center mb-12 sm:mb-10">
            ...
            <div className="font-sen w-full xl:w-5/12 lg:w-6/12 mt-4 xl:mt-6 md:mt-8 xs:mt-10">
              ...
              <p className="w-11/12 xl:w-full mb-8 sm:mb-6">
                At Luxecutz babrbers, we take pride in offering exceptional
                grooming services. Our team of barbers is not just skilled but
                handpicked for their expertise, professionalism, and commitment
                to delivering the best results. Whether it's a clean shave, a
                stylish haircut, or a more intricate grooming request, we ensure
                that every client leaves with a look tailored to their unique
                preferences.
              </p>
        ...
        <div className="flex flex-col py-4 px-4 lg:px-32 lg:py-20">
          <div className="flex flex-wrap">
            <div className="lg:w-1/2 s:w-10/12 pb-7 sm:pb-10 px-6">
              ...
              <h2 className="font-limelight text-4xl font-normal text-yellow-600 tracking-normaler w-4/5 lg:w-full mb-10 sm:mb-8">
