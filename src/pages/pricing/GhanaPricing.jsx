...
const GhanaPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["GHS 49.99", "GHS 44.99", "GHS 39.99", "GHS 34.99"],
    Plus: ["GHS 89.99", "GHS 80.99", "GHS 71.99", "GHS 62.99"],
    Pro: ["GHS 149.99", "GHS 134.99", "GHS 119.99", "GHS 104.99"],
    Extra: ["GHS 249.99", "GHS 224.99", "GHS 199.99", "GHS 174.99"],
  };
 ...
 const planFeatures = {
  ...
  const addOns = [
    {
      ...
      prices: ["GHS 49.99", "GHS 89.99", "GHS 149.99", "GHS 249.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["GHS 89.99", "GHS 89.99", "GHS 89.99", "GHS 89.99"],
    },
    {
      name: "Multi-Language",
      prices: ["GHS 149.99", "GHS 149.99", "GHS 149.99", "GHS 149.99"],
    },
  ];
  ...
  const loanOptions = [
    {
      name: "Loan Offer",
      values: ["Up to GHS 500", "Up to GHS 1,500", "Up to GHS 5,000", "Up to GHS 25,000"],
    },
    {
      name: "Minimum Monthly Volume",
      values: ["GHS 1,500+", "GHS 2,500+", "GHS 5,000+", "GHS 15,000+"],
    },
    {
      name: "Interest Rate",
