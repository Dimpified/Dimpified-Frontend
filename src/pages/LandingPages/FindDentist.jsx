...
const FindDentist = ({ subdomain }) => {
  ...
  // Fetch countries and random dentistss on mount
  useEffect(() => {
  ...
  // Fetch random dentistss
  const fetchRandomDentists = async () => {
    setIsLoading(true);
    try {
      const data = await api.getEcosystemsNearMe({
        ...
        SubCategory: "Dental Hygiene Services",
        format: "Onsite",
      });
      const randomDentists = data.ecosystems?.sort(() => 0.5 - Math.random()) || [];
      setEcosystems(randomDentists);
    } catch (err) {
    ...
    try {
      ...
      if (data?.ecosystems?.length) {
        ...
        if (filteredEcosystems.length > 0) {
          ...
          setNotification(
            " No dentist found near you, kindly search nearer local government or state."
          );
          setEcosystems([]);
        }
      } else {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Find a dentist near you </title>
        <meta
          name="description"
          content="Find a dentist near you with Dimpified "
        />
        <meta property="og:title" content=" Find a dentist near you " />
        <meta
      ...
      <div className="font-sen">
        ...
        <section
          ...
          style={{
            backgroundImage: `url("https://gfa-tech.com/dimp-template-images/dentist/dentist1.jpg")`,
          }}
        >
                ...
                {currentEcosystems
                  ...
                  .map((ecosystem, index) => {
                    ...
                    const serviceImage =
                      ...
                      "https://gfa-tech.com/dimp-template-images/dentist/dentist1.jpg";
