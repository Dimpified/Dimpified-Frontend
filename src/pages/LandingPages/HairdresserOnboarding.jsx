...
import HairdresserLeft from "./images/hairdresserright.jpg";
import HairdresserRight from "./images/hairdresserbooking.jpg";
import HairdresserMiddle from "./images/hairdressermiddle.jpg";
...
const reviews = [
  {
    name: "Tola Hair Studio, Lagos",
    text: "Since I joined Dimpified, I no longer worry about slow days. My calendar stays booked!",
  },
  {
    name: "Blessing Styles, Abuja",
    text: "I shared my link on WhatsApp and got 7 new clients in one week!",
  },
  {
    name: "Amina, Ibadan",
  ...
  },
  {
    ...
    text: "It's the first platform I've found that understands how hair professionals work. Easy to set up and even easier to run.",
  },
  {
    name: "Funke, Port Harcourt",
    text: "The insights I get from the analytics tools have helped me understand my customers better and offer the right services.",
  },
  {
    name: "Chioma, Enugu",
    text: "I love how easy it is to schedule appointments and send reminders to my clients. It has saved me so much time!",
  },
  {
    name: "Bimpe, Kano",
    text: "This software has transformed how I run my business. From client management to payments, it's a complete solution.",
  },
];

const HairdresserOnboarding = () => {
  ...
  const handleSignUp = () => {
    if (location.pathname === "/hairdressers") {
  ...
  const steps = [
    {
      number: "01",
      title: "Choose a Plan",
      description: "starting from just ₦4,500/month",
    },
    {
      number: "02",
      title: "Set Up Your Page ",
      description: "add your services, pricing & photos",
    },
    {
      number: "03",
      title: "Share & Start Earning ",
      description: "promote your link and watch bookings roll in",
    },
  ];
  return (
    <motion.div
    ...
    >
      <Helmet>
        <title>Launch Your Hairdressing Business Online with Dimpified</title>
        <meta
          name="description"
          content="Turn your hairdressing skills into a thriving online business. Showcase services, book more clients, and get paid automatically with Dimpified."
        />
        <meta
          property="og:title"
          content="Hairdresser Onboarding - Dimpified"
        />
        <meta
          property="og:description"
          content="Get a professional online presence for your hairdressing business in minutes with Dimpified."
        />
      </Helmet>
      <div className="font-sen">
        <DarkNavbar />

        <section className="py-16 md:mt-o mt-8 md:py-24 font-jak px-4 relative bg-cover bg-center bg-primary3 text-white">
          <div className="flex flex-col h-full py-4 lg:px-24  mx-auto">
            <div className="flex flex-col md:flex-row items-center h-full">
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                <div className="bg-primary4 rounded-full py-2 px-5 mb-5 w-max mx-auto md:mx-0">
                  <span className="font-semibold text-xs uppercase text-dark">
                    Dimpified for Hairdressers
                  </span>
                </div>

                <h1 className="text-4xl lg:text-7xl text-dark font-normal leading-tight mb-6">
                  Turn Your Skills Into a{" "}
                  <span className="bg-gradient-to-r from-primary4  via-primary4 to-[#222222] text-transparent bg-clip-text">
                    Thriving Online Business
                  </span>
                </h1>

                <p className="text-base md:text-lg text-dark leading-relaxed mb-8 max-w-lg">
                  Dimpified helps hairdressers like you build a professional
                  online presence in minutes — no tech skills required.
                </p>
                ...
                {/* <div className="flex flex-col md:flex-row items-center md:items-start mb-8 w-full max-w-lg">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-lg text-dark">
                      Get a custom link to promote on WhatsApp or Instagram
                    </span>
                  </div>
                </div> */}
                ...
                <div className="flex flex-col sm:flex-row  gap-4  w-auto justify-center md:justify-start">
                  <Link to="/pricing">
                    <button className="btn hover:bg-purple-800 text-white py-3 px-6 rounded-lg flex items-center justify-center bg-primary4 transition">
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-0">
              <div className="lg:w-3/12 py-10">
                <h2 className="text-2xl md:text-4xl font-semibold mb-4 font-jak ">
                  Watch How <span className="text-primary3">It Works</span>
                </h2>
                ...
                >
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      <FaQuoteLeft className="inline pr-2 text-2xl text-primary3 align-top" />
                      Since I joined Dimpified, I no longer worry about slow
                      days. My calendar stays booked!
                      <FaQuoteRight className="inline pl-2 text-2xl text-primary3 align-bottom" />
                      <br />— <strong>Tola Hair Studio, Lagos</strong>
                    </p>
                  </SwiperSlide>
                  ...
                  <SwiperSlide>
                    <p className="text-md md:text-xl text-dark mb-4 md:text-md leading-relaxed w-11/12 lg:w-full mx-auto">
                      <FaQuoteLeft className="inline pr-2 text-2xl text-primary3 align-top" />
                      I shared my link on WhatsApp and got 7 new clients in one
                      week.
                      <FaQuoteRight className="inline pl-2 text-2xl text-primary3 align-bottom" />
                      <br />— <strong>Blessing Styles, Abuja</strong>
                    </p>
                  </SwiperSlide>
                </Swiper>
              </div>
        ...
        >
          ...
          <div className=" mx-auto mb-16">
            <h2 className="text-2xl md:text-4xl font-jak font-semibold mb-4">
              Why Hairdressers Love Dimpified
            </h2>
            <p className="md:text-lg text-sm text-gray-600">
              Running a hair business is hard work.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            ...
            <div className="bg-purple-100 text-gray-800 rounded-2xl p-6 flex flex-col justify-between">
              ...
              <p className="text-gray-800 mb-4 md:text-lg text-sm">
                Let customers choose times and pay upfront. No more missed calls
                or latecomers.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
            <div className="bg-purple-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 mb-4 md:text-lg text-sm">
                Connect your bank account. Get paid before scissors touch hair.
              </p>
              <img
                src={Payment}
                alt="Drag and Drop"
            ...
            <div className="bg-gradient-to-br from-primary3 to-[#121212] text-white rounded-2xl p-6 flex flex-col justify-between">
              <h3 className="text-lg font-semibold font-jak mb-2">
                Works On Any Phone
              </h3>
              <p className="text-gray-300 mb-4 md:text-lg text-sm">
                Dimpified is mobile-friendly. Manage your hustle on the go.
              </p>
            ...
            <div className="bg-purple-100 text-gray-800 rounded-2xl p-6 flex flex-col justify-between">
              ...
              <p className="mb-4 md:text-lg text-sm">
                Track bookings, earnings, referrals & reviews — all in one
                dashboard.
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    ...
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      All hairdressers must subscribe to use Dimpified.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Plans start at ₦4,500/month — cancel anytime.
                        </span>
                      </div>
                      <div className="flex items-center">
                        <div className="bg-white p-3 rounded-full flex justify-center items-center">
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-0">
              <div className="lg:w-6/12 md:w-10/12 py-10 lg:pr-28">
                ...
                <h1 className=" font-semibold font-jak  md:text-4xl text-2xl  mb-3">
                  Built for Hairdressers. Period.
                </h1>
                <p className="text-md text-dark mb-4 leading-relaxed w-11/12 lg:w-full">
                  Dimpified is crafted to cater for you as an individual stylist
                  and also for your salon team
                </p>
                {/* Feature Box 1 */}
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">No distractions.</span>
                </div>
                {/* Feature Box 3 */}
                <div className="flex items-start mb-4">
                  <div className="w-11 h-11 bg-purple-100 border border-transparent shadow-lg rounded-full flex justify-center items-center mr-4">
                  ...
                  <span className="text-lg text-dark">
                    Just more clients, income, and freedom.
                  </span>
                </div>
                <Link to="/pricing">
        ...
        <section className="pb-6 px-6 md:px-12  md:pt-24 lg:px-40  text-gray-800 bg-cover bg-center">
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            <h2 className="text-2xl md:text-4xl font-jak  font-semibold mb-4">
              Powerful Tools to Grow Your Hair Business
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-6 animate-slide">
            ...
            {[
              ...
              },
              {
                ...
                desc: "Display your best hairstyles to attract clients",
                img: <BsWindow className="text-4xl text-blue-600" />,
              },
              {
        ...
        <section className=" lg:px-32  pb-10 bg-cover bg-center">
          <div className="mt-24 bg-purple-100 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            <h2 className="text-2xl md:text-4xl font-semibold font-jak  leading-snug mb-4">
              Join 1,000+ Hair Professionals Already Onboard
            </h2>
            <p className="mb-8">
              Hairdressers across Nigeria are turning their skills into digital
              businesses. Don't be left behind. Build Your Hair Brand the Smart
              Way.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full max-8-xl">
              <Link to="/pricing">
                ...
                <button className="btn hover:bg-gradient-to-l from-[#4f2683] via-[#9966cc] to-[#ff8201] bg-gradient-to-r text-white py-4 px-6 rounded-full flex items-center justify-center w-full md:w-auto transition">
                  <span className="mr-3 text-md">Set Up My Hair Business</span>
                  <FaArrowRight />
                </button>
              </Link>
            </div>
                      ...
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-semibold text-lg">
                            Do I need a laptop or desktop to use Dimpified?
                          </h3>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Nope! Everything works on your phone — setup and
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Clients pay online via your booking page. Funds are
                          sent directly to your Nigerian bank account.
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Yes! You can cancel anytime. But most hairdressers
                          grow their income within 30 days.
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Dimpified does the heavy lifting. Just enter your
                          name, services, and prices — your site is live in
                          minutes.
                        </DisclosurePanel>
                      </>
                    )}
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-semibold text-lg">
                            Is this only for salons or individual stylists too?
                          </h3>
                          <span className="flex items-center">
                            {open ? "-" : "+"}
                          </span>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Both! Whether you're a salon owner or mobile stylist,
                          Dimpified works perfectly for you.
                        </DisclosurePanel>
                      </>
                    )}
                  </Disclosure>
        ...
        <section className="bg-primary3  bg-cover bg-center text-white">
          <div className="mt-24 bg-primary3 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            <h2 className="text-2xl md:text-4xl font-jak  font-semibold leading-snug mb-4">
              Ready to Grow Your Hair Business?
            </h2>
            <p className="mb-8">
              Don’t wait. Start attracting more clients today.
            </p>
...
export default HairdresserOnboarding;
