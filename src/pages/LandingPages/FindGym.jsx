...
const FindGym = ({ subdomain }) => {
  ...
  // Fetch countries and random gymss on mount
  useEffect(() => {
  ...
  const fetchRandomGyms = async () => {
    ...
    try {
      const data = await api.getEcosystemsNearMe({
        ...
        SubCategory: "Personal Training and Fitness Coaching",
        format: "Onsite",
      });
      const randomGyms = data.ecosystems?.sort(() => 0.5 - Math.random()) || [];
      setEcosystems(randomGyms);
    } catch (err) {
      setError(err.message || "Failed to fetch gymss.");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    try {
      ...
      if (data?.ecosystems?.length) {
        ...
        if (filteredEcosystems.length > 0) {
          ...
          setNotification(
            " No gym found near you, kindly search nearer local government or state."
          );
          setEcosystems([]);
        }
      } else {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Find a gym near you </title>
        <meta
          name="description"
          content="Find a gym near you with Dimpified "
        />
        <meta property="og:title" content=" Find a gym near you " />
        <meta
      ...
      <div className="font-sen">
        ...
        <section
          ...
          style={{
            backgroundImage: `url("https://gfa-tech.com/dimp-template-images/gym/gym1.jpg")`,
          }}
        >
                ...
                {currentEcosystems
                  ...
                  .map((ecosystem, index) => {
                    ...
                    const serviceImage =
                      ...
                      "https://gfa-tech.com/dimp-template-images/gym/gym1.jpg";
