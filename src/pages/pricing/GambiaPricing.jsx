...
const GambiaPricing = () => {
  ...
  const subscriptionData = {
    Lite: ["GMD 599.99", "GMD 539.99", "GMD 479.99", "GMD 419.99"],
    Plus: ["GMD 1,099.99", "GMD 989.99", "GMD 879.99", "GMD 769.99"],
    Pro: ["GMD 1,799.99", "GMD 1,619.99", "GMD 1,439.99", "GMD 1,259.99"],
    Extra: ["GMD 2,999.99", "GMD 2,699.99", "GMD 2,399.99", "GMD 2,099.99"],
  };
 ...
 const planFeatures = {
  ...
  const addOns = [
    {
      ...
      prices: ["GMD 599.99", "GMD 1,099.99", "GMD 1,799.99", "GMD 2,999.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["GMD 1,099.99", "GMD 1,099.99", "GMD 1,099.99", "GMD 1,099.99"],
    },
    {
      name: "Multi-Language",
      prices: ["GMD 1,799.99", "GMD 1,799.99", "GMD 1,799.99", "GMD 1,799.99"],
    },
  ];
  ...
  const loanOptions = [
    {
      name: "Loan Offer",
      values: ["Up to GMD 500", "Up to GMD 1,500", "Up to GMD 5,000", "Up to GMD 25,000"],
    },
    {
      name: "Minimum Monthly Volume",
      values: ["GMD 1,500+", "GMD 2,500+", "GMD 5,000+", "GMD 15,000+"],
    },
    {
      name: "Interest Rate",
