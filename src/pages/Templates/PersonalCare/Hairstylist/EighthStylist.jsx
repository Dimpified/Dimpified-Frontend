...
const services = [
  {
    ...
    image: "https://i.imghippo.com/files/Ezd8080QPw.jpg",
  },
  {
    title: "Hair Style Mix",
    subtitle: "Beauty Salon",
    image: "https://i.imghippo.com/files/ofdm9243UlY.jpg",
  },
  {
    title: "Women Hair Color",
    subtitle: "Beauty Salon",
    image: "https://i.imghippo.com/files/cVJd1253pN.jpg",
  },
];
const services2 = [
  {
    title: "Hair Colors",
    image: "https://i.imghippo.com/files/lt3657tzI.jpg",
    bgLabel: "Color",
    description: "Get a vibrant, personalized color treatment just for you.",
  },
  {
    title: "Hair Washing",
    image: "https://i.imghippo.com/files/AnBh4680GqM.jpg",
    bgLabel: "Wash",
    description: "Relax and refresh with a deep, cleansing hair wash.",
  },
  {
    title: "Hair Cutting",
    image: "https://i.imghippo.com/files/nyy5307y.jpg",
    bgLabel: "Cut",
    description: "Professional haircuts tailored to your unique style.",
  },
  {
    title: "Hair Massage",
    image: "https://i.imghippo.com/files/Qqn6027OJ.jpg",
    bgLabel: "Style",
...
const EightStylist = ({userDetails}) => {
  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage:
            "url('https://i.imghippo.com/files/TU4797XU.jpg')",
        }}
      >
        {/* Overlay */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group">
              <img
                src="https://i.imghippo.com/files/wlf8271PVI.jpg"
                alt="Hair Cutting"
            ...
            <div className="relative group">
              <img
                src="https://i.imghippo.com/files/JP8890tA.jpg"
                alt="Hair Cutting"
                className="w-full h-full object-cover rounded"
              />
              <div className="absolute inset-0 bg-black opacity-20 group-hover:opacity-40 transition rounded"></div>
            ...
            <div className="relative group">
              <img
                src="https://i.imghippo.com/files/ECLe1506HWA.jpg"
                alt="Hair Cutting"
                className="w-full h-full object-cover rounded"
              />
              <div className="absolute inset-0 bg-black opacity-20 group-hover:opacity-40 transition rounded"></div>
      ...
      <section className="bg-[#f8f8f8] relative overflow-hidden py-20 px-4 md:px-16">
        <section id="gallery" className="relative px-4 md:px-32 ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <img
              src="https://i.imghippo.com/files/nGzy7975jmg.jpg"
              alt="Hair coloring"
            ...
            />
            <img
              src="https://i.imghippo.com/files/GPw7426C.jpg"
              alt="Makeup"
              className="w-full h-64 object-cover rounded-lg"
            />
            <img
              src="https://i.imghippo.com/files/pF2187MIk.jpg"
              alt="Natural hair"
              className="w-full h-64 object-cover rounded-lg"
            />
            <img
              src="https://i.imghippo.com/files/AnBh4680GqM.jpg"
              alt="Styling"
              className="w-full h-64 object-cover rounded-lg"
            />
          </div>
      ...
      <section className="bg-white w-full mt-20">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between p-10 bg-[#f8f8f8] min-h-[600px] relative">
            <div className="flex flex-col justify-center items-center text-center mt-6">
              ...
              <div className="flex items-center space-x-3 z-10 mt-2">
                <img
                  src="https://i.imghippo.com/files/nyy5307y.jpg"
                  alt="user"
          ...
          <div className="h-[600px] w-full">
            <img
              src="https://i.imghippo.com/files/Jq8617dE.jpg"
              alt="client"
              className="w-full h-full object-cover"
            />
          </div>
