...
// Import images
import NailImg from "./images/nt1.jpg";
import NailBooking from "./images/mk2.jpg";
import NailMoney from "./images/hairdresser-money.jpg";
import NailCustomer from "./images/nt2.jpg";
...
const NailLanding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Dimpified For Nail Technicians </title>
        <meta
          name="description"
          content="   Dimpified is the secret tool top nail techs use but won't tell"
        />
        <meta property="og:title" content=" Dimpified For Nail Technicians " />
        <meta
          ...
          <div className="flex flex-col h-full py-4 px-4 lg:px-24">
            <div className="flex flex-col md:flex-row items-center h-full">
              <div className="md:w-1/2 px-3 flex flex-col justify-center h-full">
                <h1 className="lg:text-pXXL text-[3rem] text-dark font-normal leading-tight mb-6">
                  <span>
                    Dimpified is the
                    <br /> secret tool{" "}
                  </span>{" "}
                  ...
                  <span className="font-bold bg-gradient-to-r from-[#4f2683]  via-[#9966cc] to-[#ff8201] text-transparent bg-clip-text">
                    top nail techs use but won't tell
                  </span>
                </h1>
                <p className="text-lg text-dark leading-relaxed mb-8 w-4/5">
                  They create a stunning website for their nail services,
                  showcase designs, set prices, get booked effortlessly, and
                  receive payments upfront— all while focusing on their art.
                </p>
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <Link to="/nailtechs-near-me">
                    <button className="btn hover:text-white hover:bg-gradient-to-l w-full text-center from-[#4f2683]  via-[#9966cc] to-[#ff8201] border-2 border-primary3 text-primary3 py-4 lg:px-6 px-3 rounded-lg flex items-center justify-center transition">
                      <span className="mr-3">Find a nail tech near me</span>
                      <FaArrowRight />
                    </button>
                  </Link>
                </div>
            ...
            <div className="flex flex-wrap items-end justify-center mb-5 text-center md:text-start">
              <div className="xl:w-6/12 lg:w-6/12 md:w-10/12 mb-4">
                <h3 className="bg-gradient-to-r from-blue-500 via-orange-500 to-pink-500 bg-clip-text text-transparent md:text-4xl text-3xl  font-medium mb-1 tracking-tight">
                  Your skills and creativity with nails are invaluable—take
                  control of how you earn from them.
                </h3>
              </div>
              <div className="xl:w-5/12 lg:w-6/12 md:w-10/12 xl:ml-auto">
                <p className="w-11/12 md:w-4/5 mx-auto md:mx-0">
                  You’ve mastered your craft; now let us help you maximize your
                  time and income. With our platform, clients can easily book
                  your nail services, making it simple for you to manage
                  appointments and get paid upfront, so you can focus on
              ...
              <div className="self-start">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Create a professional online presence to showcase your
                      nail services and artistry.
                    </p>
              ...
              <div className="self-end mt-10 lg:mt-0">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      List your services with clear pricing, and offer clients
                      the option to choose between in-studio or mobile
                      appointments.
                    </p>
                    <span className="block w-16 h-0.5 bg-gray-800"></span>
                  </div>
              ...
              <div className="self-start">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Enable clients to schedule appointments directly on your
                      website with automated reminders, ensuring you never miss
                      a booking.
                    </p>
                    <span className="block w-16 h-0.5 bg-gray-800"></span>
                  </div>
              ...
              <div className="self-end mt-10">
                <div className="relative lg:px-8 sm:px-4">
                  ...
                  <div className="pt-16 sm:pt-10">
                    ...
                    <p className="mb-2">
                      Get paid before appointments to ensure your income is
                      secure and you can focus on delivering exceptional nail
                      services.
                    </p>
                    <span className="block w-16 h-0.5 bg-gray-800"></span>
                  </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full lg:h-auto">
                  ...
                  <div className="lg:w-6/12 md:w-10/12 py-10 px-8">
                    <span className="text-md font-bold uppercase px-6 py-1 mb-5 inline-flex text-dark bg-gray-100 rounded-full">
                      Showcase Your Nail Artistry
                    </span>
                    <h1 className="text-3xl lg:text-4xl font-normal tracking-tight text-dark mb-4">
                      Build Your Nail Studio Website in Minutes
                    </h1>
                    <p className="text-dark text-lg lg:w-4/5 mb-6">
                      <span className="font-normal">Your website</span> is your
                      online nail studio. Quickly create a professional site to
                      showcase your nail services, stunning nail art portfolio,
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center">
                      ...
                      <div className="flex items-start mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Easy-to-use tools and templates for effortless site
                          creation.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Showcase your best nail art designs in a stunning
                          portfolio.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Display your services and pricing to streamline
                          booking.
                        </p>
                      </div>
                      ...
                      <div className="flex items-center mb-4">
                        ...
                        <p className="text-dark font-medium">
                          Share customer reviews to build trust with potential
                          clients.
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    <span className="font-bold text-sm py-2 px-5 mb-3 inline-block uppercase text-dark bg-gradient-to-r from-pink-100 to-transparent rounded-full">
                      Simplified Booking for Nail Technicians
                    </span>
                    <h1 className="font-normal md:text-4xl text-3xl  text-dark mb-3">
                      Streamline Your Client's Appointments
                    </h1>
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      Say goodbye to booking confusion. Our intuitive booking
                      system lets clients schedule their nail services online,
                      make secure payments, and receive instant confirmations.
                      Effortlessly manage your appointments from your dashboard,
                      keeping your schedule seamless and your business
                      flourishing.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Clients can book their appointments anytime online.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Automatic reminders to help avoid missed appointments.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Manage your customer's nail appointments effortlessly
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Customize your nail services and availability to fit
                          your unique style.
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      <span>
                        Start Recieving Bookings From Your Clients Today!
                      </span>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-0">
              ...
              <div className="lg:w-6/12 md:w-10/12 py-10">
                ...
                <p className="text-md text-dark mb-4 leading-relaxed w-11/12 lg:w-full">
                  ...
                  for a successful nail business. Use our tools to track their
                  preferences, understand what they love, and ensure they keep
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">
                    Analyze trends and client preferences with an easy-to-use
                    dashboard.
                  </span>
                </div>
                ...
                <div className="flex items-start mb-4">
                  ...
                  <span className="text-lg text-dark">
                    Engage clients with special offers and updates via email and
                    SMS tools.
                  </span>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-lg text-dark">
                    Show appreciation to loyal clients with customizable loyalty
                    programs.
                  </span>
                </div>
              </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-1 lg:order-2 lg:w-5/12 mb-4 lg:mb-0 lg:pr-16">
                    <img
                      ...
                      alt="Increase Your Nail Earnings"
                    />
                  </div>
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-16">
                    <span className="font-bold text-sm py-2 px-5 mb-3 inline-block uppercase text-dark bg-orange-50 rounded-full">
                      Boost Your Nail Business
                    </span>
                    <h1 className="font-normal md:text-4xl text-3xl  text-dark mb-3">
                      Get Paid Before Your Tools Touch the Nails
                    </h1>
                    <p className="text-md text-dark mb-4 leading-relaxed">
                      Maximize your income by offering prepayment options and
                      expanding your nail business. Clients can book and pay in
                      advance, making your earnings more predictable and
                      ensuring a steady stream of business.
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      {/* Feature 1 */}
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Add diverse nail services like manicures, pedicures,
                          and nail art.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Use secure payment systems for hassle-free
                          transactions.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Offer special packages and discounts to attract and
                          retain clients.
                        </span>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 text-dark text-md leading-relaxed">
                          Access your earnings easily with fast and secure
                          withdrawals.
                        </span>
                      </div>
                    </div>
            ...
            <div className="flex items-center justify-center text-center mb-6">
              <div className="xl:w-10/12">
                <h2 className="font-alt  md:text-4xl text-3xl  font-normal text-gray-800 tracking-tight mb-0">
                  Lots of Nail Technicians use Dimpified for their business.
                </h2>
              </div>
            </div>
          ...
          <div className="bg-[#e926a8] py-12 px-6 lg:py-40 lg:px-20 lg:mx-20 rounded-3xl text-center">
            <div>
              <h2 className="text-4xl font-light text-white tracking-tight mb-4">
                Your nail business just got way more easier.
              </h2>
              <p className="text-white text-lg mb-6">
                Forget rent. Get a website. Set services and prices. Get booked.
                Get your money first. Delight clients with flawless nails.
              </p>
              <Link to="/pricing">
                {" "}
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Our platform is designed to help professional Nail
                          Technicians manage their online presence, client
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <DisclosureButton className="flex justify-between w-full py-4 text-left text-gray-800">
                          <h3 className="font-bold text-lg">
                            How does the booking feature benefit my Nail
                            Technician business?
                          </h3>
                          <span className="flex items-center">
                            {open ? "-" : "+"}
