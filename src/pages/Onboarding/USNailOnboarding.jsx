...
import Payment from "../LandingPages/images/payment.jpg";
...
const reviews = [
  ...
  {
    name: "Brianna, Nail Tech – Atlanta, GA",
  ...
  },
  {
    ...
    text: "Setting up my online booking page was so easy. Clients can view my nail designs and book anytime—even at night. My salon stays busy!",
  },
  {
    name: "Carmen, Nail Artist – Miami, FL",
    text: "Finally, a platform that gets nail salons. It’s easy to use, looks great, and takes care of all the boring stuff so I can focus on nails.",
  },
  {
    name: "Alyssa, Houston, TX",
    text: "The analytics tools show me what services are trending and when my clients book the most. It helps me plan specials and promos better!",
  },
  {
    name: "Rachel, Nail Educator – Chicago, IL",
    text: "As someone who teaches and still takes clients, this software helped me streamline bookings and scale up my sessions. Game-changing!",
  },
  {
    name: "Taylor, San Diego, CA",
    text: "I used to lose so much time on confirmations and reschedules. Now clients book and get reminders automatically. My no-shows dropped like crazy!",
  },
  {
    name: "Danielle, Phoenix, AZ",
    text: "From tracking polish inventory to keeping up with clients, this system runs my nail salon smoother than ever. Total life-saver!",
  },
  {
    name: "Megan, Charlotte, NC",
    text: "It took me less than an hour to set up my profile and services. Now I get appointments without answering a million DMs. Love it!",
  },
  {
    name: "Vanessa, Denver, CO",
    text: "My clients rave about the reminders and how easy it is to book. It’s helped me stay organized and fully booked week after week.",
  },
  {
    name: "Nicole, Seattle, WA",
    text: "I never thought running my nail business could feel this effortless. One app handles it all—bookings, payments, reminders, and more!",
  },
  {
    name: "Sierra, Orlando, FL",
    text: "The support team was so helpful during setup. Now I’ve got a beautiful booking page and I’m seeing new clients almost every day.",
  },
  {
    name: "Madison, Nashville, TN",
    text: "The built-in marketing features help me send promos and keep my regulars engaged. I’m growing my nail business without paying for ads!",
  },
];

const USNailOnboarding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        />
        <meta property="og:title" content="USNailOnboarding Us - My App" />
        <meta
              ...
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                <div className="bg-primary3 rounded-full py-2 px-5 mb-5 w-max mx-auto md:mx-0">
                  <span className="font-semibold text-xs uppercase text-dark">
                    Trusted by barbers across the United States
                  </span>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    ...
                    <h1 className="font-semibold font-jak md:text-4xl text-2xl  text-dark mb-3">
                      Trusted by Hundreds of Beauty Entrepreneurs Across the
                      United States
                    </h1>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          $19.99. Upgrade for advanced features like SMS
...
export default USNailOnboarding;
