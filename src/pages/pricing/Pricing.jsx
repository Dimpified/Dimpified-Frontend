...
const Pricing = () => {
  ...
  const pricingPlans = ["Monthly", "Quarterly", "Half-Yearly", "Annually"];
        ...
        <div className="flex flex-col h-full py-4 px-4 lg:px-24">
          <div className="flex flex-col md:flex-row items-center h-full">
            <div className="md:w-1/2 px-3 flex flex-col justify-center h-full">
              <h1 className="lg:text-5xl text-[2rem] text-dark font-normal leading-tight my-6">
          ...
          <div className="inline-flex rounded-md">
            {pricingPlans.map((plan) => (
              <button
                ...
                } ${plan === pricingPlans[0] ? "rounded-l-lg" : ""} ${
