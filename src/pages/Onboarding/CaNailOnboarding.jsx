...
const reviews = [
  {
    name: "Jasmine, Toronto, ON",
    text: "Since using this platform, my nail appointments have doubled! I’m seeing more returning clients than ever. Managing everything from my phone is a total game-changer!",
  },
  {
    name: "Brianna, Nail Tech – Vancouver, BC",
    text: "No more chasing DMs! My clients now book, pay, and get automatic reminders. It’s made my day-to-day so much easier and more professional.",
  },
  {
    name: "Olivia, Montréal, QC",
    text: "Setting up my online booking page was so easy. Clients can view my nail designs and book anytime—even at night. My studio stays booked solid!",
  },
  {
    name: "Carmen, Nail Artist – Calgary, AB",
    text: "Finally, a platform that gets nail salons. It’s simple to use, looks amazing, and handles the admin stuff so I can focus on nails.",
  },
  {
    name: "Alyssa, Ottawa, ON",
    text: "The analytics tools show me which services are popular and when clients tend to book. It’s helped me plan promotions and boost slow days!",
  },
  {
    name: "Rachel, Nail Educator – Edmonton, AB",
    text: "As someone who teaches and still takes clients, this platform helped me simplify bookings and grow my sessions. Total game-changer!",
  },
  {
    name: "Taylor, Mississauga, ON",
    text: "I used to spend hours confirming appointments. Now clients book online and get reminders—my no-shows dropped big time!",
  },
  {
    name: "Danielle, Winnipeg, MB",
    text: "From tracking my polish stock to managing my client list, this system keeps my nail studio running smoother than ever. Love it!",
  },
  {
    name: "Megan, Halifax, NS",
    text: "It took me less than an hour to set up my profile and services. I’m now getting booked straight from the app—no more back-and-forth messaging!",
  },
  {
    name: "Vanessa, Regina, SK",
    text: "My clients love the reminders and how easy it is to book. It’s helped me stay organized and fully booked week after week.",
  },
  {
    name: "Nicole, Surrey, BC",
    text: "I never imagined managing my nail business could be this effortless. One app takes care of bookings, payments, reminders—you name it!",
  },
  {
    name: "Sierra, Brampton, ON",
    text: "The support team was super helpful during setup. Now I’ve got a beautiful booking page and I’m seeing new clients almost daily.",
  },
  {
    name: "Madison, St. John’s, NL",
    text: "The built-in marketing tools help me send offers and keep my regulars engaged. I’m growing my nail business without spending on ads!",
  },
];

const CaNailOnboarding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        />
        <meta property="og:title" content="CaNailOnboarding Us - My App" />
        <meta
              ...
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                <div className="bg-primary3 rounded-full py-2 px-5 mb-5 w-max mx-auto md:mx-0">
                  <span className="font-semibold text-xs uppercase text-dark">
                    Trusted by barbers across Canada
                  </span>
                </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center h-full">
                  ...
                  <div className="order-2 lg:order-1 xl:ml-4 lg:w-6/12 lg:px-24">
                    ...
                    <h1 className="font-semibold font-jak md:text-4xl text-2xl  text-dark mb-3">
                      Trusted by Hundreds of Beauty Entrepreneurs Across Canada
                    </h1>
                  ...
                  <Disclosure className="bg-white p-4">
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          Dimpified connects with top American payment
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          $24.99. Upgrade for advanced features like SMS
...
export default CaNailOnboarding;
