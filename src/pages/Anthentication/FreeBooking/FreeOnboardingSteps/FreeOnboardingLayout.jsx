// components/layouts/FreeOnboardingLayout.jsx
...
const FreeOnboardingLayout = ({
  ...
  const STEP_LABELS = ["Basic Info", "Verify", "Setup", "Review"];
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      >
        ...
        {/* FORM CONTENT */}
        <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col justify-start">
          {children}
        </div>
      </div>
...
FreeOnboardingLayout.propTypes = {
...
FreeOnboardingLayout.defaultProps = {
  currentStep: 1,
  onBack: null,
  backDisabled: false,
  rightImage: RightImage,
...
export default FreeOnboardingLayout;
