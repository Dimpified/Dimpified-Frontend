            ...
            <div className="flex flex-col lg:flex-row justify-center gap-0">
              <div className="lg:w-3/12 py-10">
                ...
                <p className="text-md text-dark mb-4 text-xl  leading-relaxed w-11/12 lg:w-full">
                  <FaQuoteLeft className="pr-4 text-4xl text-primary3" />
                  Since moving to Dimpified, bookings doubled in just one month.
                  Clients love how easy it is to book me. I love how
                  professional it makes my brand look.
                  <br /> — Jemima G., Pro MUA in Lagos{" "}
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <DisclosurePanel className="text-gray-500 pb-4">
                          ...
                          ₦4,500/month. Your business deserves more than “free.”
...
export default MakeupOnboarding;
