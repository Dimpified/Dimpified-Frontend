...
const SingaporePricing = () => {
  ...
  const subscriptionData = {
    Lite: ["SGD 19.99", "SGD 17.99", "SGD 15.99", "SGD 13.99"],
    Plus: ["SGD 34.99", "SGD 31.49", "SGD 27.99", "SGD 24.49"],
    Pro: ["SGD 59.99", "SGD 53.99", "SGD 47.99", "SGD 41.99"],
    Extra: ["SGD 99.99", "SGD 89.99", "SGD 79.99", "SGD 69.99"],
  };
 ...
 const planFeatures = {
  ...
  const addOns = [
    {
      ...
      prices: ["SGD 19.99", "SGD 34.99", "SGD 59.99", "SGD 99.99"],
    },
    {
      name: "Custom Domain (Annual)",
      prices: ["SGD 34.99", "SGD 34.99", "SGD 34.99", "SGD 34.99"],
    },
    {
      name: "Multi-Language",
      prices: ["SGD 59.99", "SGD 59.99", "SGD 59.99", "SGD 59.99"],
    },
  ];
  ...
  const loanOptions = [
    {
      name: "Loan Offer",
      values: ["Up to SGD 500", "Up to SGD 1,500", "Up to SGD 5,000", "Up to SGD 25,000"],
    },
    {
      name: "Minimum Monthly Volume",
      values: ["SGD 1,500+", "SGD 2,500+", "SGD 5,000+", "SGD 15,000+"],
    },
    {
      name: "Interest Rate",
