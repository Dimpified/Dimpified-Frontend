...
const reviews = [
  {
    name: "Jason, Houston, TX",
    text: "Since using this software, my class bookings have doubled, and I’ve seen a big jump in returning members. Managing everything from my phone is a total game-changer!",
  },
  {
    name: "Marcus, Gym Owner – Atlanta, GA",
    text: "I stopped juggling text messages and DMs. Now, members can book online, pay up front, and get automatic reminders. It’s made my life so much easier.",
  },
  {
    name: "Ashley, Miami, FL",
    text: "Setting up my website was super easy. Members can see our schedule, check out our trainers, and book sessions 24/7. Business is booming!",
  },
  {
    name: "Danielle, Fitness Coach – Los Angeles, CA",
    text: "It’s the first platform I’ve found that truly understands gyms and fitness studios. Easy setup and even easier to run day-to-day.",
  },
  {
    name: "Chris, Chicago, IL",
    text: "The analytics tools help me track member trends, monitor class performance, and run better promotions. It’s made a huge impact on how I manage the gym.",
  },
  {
    name: "Brian, Personal Trainer – New York, NY",
    text: "This platform helped me bring my coaching online and triple my client base. I can’t imagine running my sessions without it now.",
  },
  {
    name: "Lena, Denver, CO",
    text: "I love how simple it is to manage bookings and send reminders to my clients. It’s saved me hours every week and cut down on no-shows dramatically!",
  },
  {
    name: "Eric, Phoenix, AZ",
    text: "This software has transformed how I operate. From inventory tracking to member engagement—it’s an all-in-one solution I rely on every day.",
  },
  {
    name: "Samantha, Charlotte, NC",
    text: "It only took a few minutes to set up my profile and class offerings. Now I get bookings straight from the app and spend more time doing what I love—training!",
  },
  {
    name: "Tony, Seattle, WA",
    text: "The automated reminders have been a game-changer. My members love the convenience, and my retention rate has gone way up.",
  },
  {
    name: "Michael, Nashville, TN",
    text: "I never thought I could manage my entire gym from one platform. It’s seamless, fast, and has seriously boosted my productivity!",
  },
  {
    name: "Vanessa, Philadelphia, PA",
    text: "The support team is fantastic! They helped me get set up quickly and now I have a polished online presence that brings in new members every week.",
  },
  {
    name: "DeShawn, Detroit, MI",
    text: "The built-in marketing tools help me run promotions and keep my regulars coming back. I’ve grown my gym without needing outside help!",
  },
];

const USGymOnboarding = () => {
  ...
  return (
    ...
    >
      <Helmet>
        ...
        />
        <meta property="og:title" content="USGymOnboarding Us - My App" />
        <meta
            ...
            <div className="flex flex-col md:flex-row items-center h-full">
              <div className="md:w-1/2 flex flex-col justify-center h-full items-center md:items-start text-center md:text-left">
                ...
                <p className="text-base md:text-lg text-dark leading-relaxed mb-8 max-w-lg">
                  Trusted by gyms across the United States. Subscription
                  required — starting at $19.99/month.
                </p>
        ...
        <section className="bg-primary3  bg-cover bg-center text-white">
          <div className="mt-24 bg-primary3 rounded-3xl md:py-32 md:px-32 py-20 px-6 flex flex-col items-center justify-center text-center relative overflow-hidden  mx-auto">
            <h2 className="text-2xl md:text-4xl font-jak  font-semibold leading-snug mb-4">
              Join the United States’s Digital Fitness Revolution
            </h2>
            <p className="mb-8">
...
export default USGymOnboarding;
